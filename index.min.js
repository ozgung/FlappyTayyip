!function(t, e) {
    ...
    e.InteractionManager = function() {
            ...
            if (e + 1 >= t.length)
                switch (s) {
                    case 1:
                        ...
                        break;
                    case 3:
                        var r = Math.ceil((n = e - t.length) / 2), o = n - r;
            ...
            if ("object" != typeof t || t.nodeType || t === t.window)
                return !1;
            try {
                if (t.constructor && !hasOwn.call(t.constructor.prototype, "isPrototypeOf"))
                    return !1
            } catch (e) {
                return !1
            }
            ...
            var t, e, s, n, r, o, a = arguments[0] || {}, h = 1, l = arguments.length, c = !1;
            for ("boolean" == typeof a && (c = a, a = arguments[1] || {}, h = 2), l === h && (a = this, --h); l > h; h++)
                if (null != (t = arguments[h]))
                    for (e in t)
                        s = a[e], n = t[e], a !== n && (c && n && (i.Utils.isPlainObject(n) || (r = Array.isArray(n))) ? (r ? (r = !1, o = s && Array.isArray(s) ? s : []) : o = s && i.Utils.isPlainObject(s) ? s : {}, a[e] = i.Utils.extend(c, o, n)) : void 0 !== n && (a[e] = n));
            return a
        ...
        i || (i = t);
        var s = t[0], n = t[1], r = t[2], o = t[3], a = t[4], h = t[5], l = t[6], c = t[7], u = t[8], d = e[0], p = e[1], f = e[2], g = e[3], m = e[4], y = e[5], _ = e[6], x = e[7], v = e[8];
        ...
        if (!e || t === e) {
            var i = t[1], s = t[2], n = t[3], r = t[6], o = t[7], a = t[11];
        ...
        i || (i = t);
        var s = t[0], n = t[1], r = t[2], o = t[3], a = t[4], h = t[5], l = t[6], c = t[7], u = t[8], d = t[9], p = t[10], f = t[11], g = t[12], m = t[13], y = t[14], _ = t[15], x = e[0], v = e[1], b = e[2], w = e[3];
        ...
        if (t instanceof Array || (t = Array.prototype.slice.call(arguments)), "number" == typeof t[0]) {
            for (var i = [], s = 0, n = t.length; n > s; s += 2)
                i.push(new e.Point(t[s], t[s + 1]));
            t = i
        }
        this.points = t
        ...
        for (var i = !1, s = 0, n = this.points.length - 1; s < this.points.length; n = s++) {
            var r = this.points[s].x, o = this.points[s].y, a = this.points[n].x, h = this.points[n].y, l = o > e != h > e && (a - r) * (e - o) / (h - o) + r > t;
            l && (i = !i)
        }
        return i
        ...
        var i = new e.FilterBlock, s = new e.FilterBlock;
        ...
        var t = this.localTransform, i = this.parent.worldTransform, s = this.worldTransform;
        t[0] = this._cr * this.scale.x, t[1] = -this._sr * this.scale.y, t[3] = this._sr * this.scale.x, t[4] = this._cr * this.scale.y;
        var n = this.pivot.x, r = this.pivot.y, o = t[0], a = t[1], h = this.position.x - t[0] * n - r * t[1], l = t[3], c = t[4], u = this.position.y - t[4] * r - n * t[3], d = i[0], p = i[1], f = i[2], g = i[3], m = i[4], y = i[5];
        ...
        var i, s, n = t.first, r = t.last;
        s = this._filters || this._mask ? this.last._iPrev : this.last, i = s._iNext;
        for (var o = this, a = s; o; )
            o.last === a && (o.last = t.last), o = o.parent;
        ...
        if (void 0 !== t.parent && t.parent.removeChild(t), t.parent = this, this.stage) {
            var i = t;
            do
                i.interactive && (this.stage.dirty = !0), i.stage = this.stage, i = i._iNext;
            while (i)
        }
        var s, n, r = t.first, o = t.last;
        if (e === this.children.length) {
            n = this.last;
            for (var a = this, h = this.last; a; )
                a.last === h && (a.last = t.last), a = a.parent
        } else
            n = 0 === e ? this : this.children[e - 1].last;
        ...
        if (t !== e) {
            var i = this.children.indexOf(t), s = this.children.indexOf(e);
            if (0 > i || 0 > s)
        ...
        if (-1 === e)
            throw new Error(t + " The supplied DisplayObject must be a child of the caller " + this);
        var i = t.first, s = t.last, n = s._iNext, r = i._iPrev;
    ...
    }, e.CustomRenderable.prototype = Object.create(e.DisplayObject.prototype), e.CustomRenderable.prototype.constructor = e.CustomRenderable, e.CustomRenderable.prototype.renderCanvas = function() {
        ...
        var t = this.points;
        if (!(t.length < 1)) {
            var e = this.uvs, i = t[0], s = this.indices, n = this.colors;
            this.count -= .2, e[0] = 0, e[1] = 1, e[2] = 0, e[3] = 1, n[0] = 1, n[1] = 1, s[0] = 0, s[1] = 1;
            for (var r, o, a, h = t.length, l = 1; h > l; l++)
                r = t[l], o = 4 * l, a = l / (h - 1), l % 2 ? (e[o] = a, e[o + 1] = 0, e[o + 2] = a, e[o + 3] = 1) : (e[o] = a, e[o + 1] = 0, e[o + 2] = a, e[o + 3] = 1), o = 2 * l, n[o] = 1, n[o + 1] = 1, o = 2 * l, s[o] = o, s[o + 1] = o + 1, i = r
        }
    }, e.Rope.prototype.updateTransform = function() {
        var t = this.points;
        if (!(t.length < 1)) {
            var i, s = t[0], n = {x: 0,y: 0};
            this.count -= .2;
            var r = this.verticies;
            r[0] = s.x + n.x, r[1] = s.y + n.y, r[2] = s.x - n.x, r[3] = s.y - n.y;
            for (var o, a, h, l, c, u = t.length, d = 1; u > d; d++)
                o = t[d], a = 4 * d, i = d < t.length - 1 ? t[d + 1] : o, n.y = -(i.x - s.x), n.x = i.y - s.y, h = 10 * (1 - d / (u - 1)), h > 1 && (h = 1), l = Math.sqrt(n.x * n.x + n.y * n.y), c = this.texture.height / 2, n.x /= l, n.y /= l, n.x *= c, n.y *= c, r[a] = o.x + n.x, r[a + 1] = o.y + n.y, r[a + 2] = o.x - n.x, r[a + 3] = o.y - n.y, s = o;
        ...
        this.currentPath.points.length || this.graphicsData.pop(), this.currentPath = {lineWidth: this.lineWidth,lineColor: this.lineColor,lineAlpha: this.lineAlpha,fillColor: this.fillColor,fillAlpha: this.fillAlpha,fill: this.filling,points: [t, i, s, n],type: e.Graphics.RECT}, this.graphicsData.push(this.currentPath), this.dirty = !0
    }, e.Graphics.prototype.drawCircle = function(t, i, s) {
        this.currentPath.points.length || this.graphicsData.pop(), this.currentPath = {lineWidth: this.lineWidth,lineColor: this.lineColor,lineAlpha: this.lineAlpha,fillColor: this.fillColor,fillAlpha: this.fillAlpha,fill: this.filling,points: [t, i, s, s],type: e.Graphics.CIRC}, this.graphicsData.push(this.currentPath), this.dirty = !0
    }, e.Graphics.prototype.drawEllipse = function(t, i, s, n) {
        this.currentPath.points.length || this.graphicsData.pop(), this.currentPath = {lineWidth: this.lineWidth,lineColor: this.lineColor,lineAlpha: this.lineAlpha,fillColor: this.fillColor,fillAlpha: this.fillAlpha,fill: this.filling,points: [t, i, s, n],type: e.Graphics.ELIP}, this.graphicsData.push(this.currentPath), this.dirty = !0
        ...
        if (!this.bounds) {
            for (var t, i, s, n = 1 / 0, r = -1 / 0, o = 1 / 0, a = -1 / 0, h = 0; h < this.graphicsData.length; h++) {
                var l = this.graphicsData[h], c = l.type, u = l.lineWidth;
                if (t = l.points, c === e.Graphics.RECT) {
                    i = t.x - u / 2, s = t.y - u / 2;
                    var d = t.width + u, p = t.height + u;
                    ...
                    for (var g = 0; g < t.length; g += 2)
                        i = t[g], s = t[g + 1], n = n > i - u ? i - u : n, r = i + u > r ? i + u : r, o = o > s - u ? s - u : o, a = s + u > a ? s + u : a
            }
            this.bounds = new e.Rectangle(n, o, r - n, a - o)
        }
    }, e.Graphics.POLY = 0, e.Graphics.RECT = 1, e.Graphics.CIRC = 2, e.Graphics.ELIP = 3, e.CanvasGraphics = function() {
    }, e.CanvasGraphics.renderGraphics = function(t, i) {
        for (var s = t.worldAlpha, n = "", r = 0; r < t.graphicsData.length; r++) {
            var o = t.graphicsData[r], a = o.points;
            if (i.strokeStyle = n = "#" + ("00000" + (0 | o.lineColor).toString(16)).substr(-6), i.lineWidth = o.lineWidth, o.type === e.Graphics.POLY) {
                ...
                (o.fillColor || 0 === o.fillColor) && (i.globalAlpha = o.fillAlpha * s, i.fillStyle = n = "#" + ("00000" + (0 | o.fillColor).toString(16)).substr(-6), i.fillRect(a[0], a[1], a[2], a[3])), o.lineWidth && (i.globalAlpha = o.lineAlpha * s, i.strokeRect(a[0], a[1], a[2], a[3]));
            else if (o.type === e.Graphics.CIRC)
                i.beginPath(), i.arc(a[0], a[1], a[2], 0, 2 * Math.PI), i.closePath(), o.fill && (i.globalAlpha = o.fillAlpha * s, i.fillStyle = n = "#" + ("00000" + (0 | o.fillColor).toString(16)).substr(-6), i.fill()), o.lineWidth && (i.globalAlpha = o.lineAlpha * s, i.stroke());
            else if (o.type === e.Graphics.ELIP) {
                var l = o.points, c = 2 * l[2], u = 2 * l[3], d = l[0] - c / 2, p = l[1] - u / 2;
                i.beginPath();
                var f = .5522848, g = c / 2 * f, m = u / 2 * f, y = d + c, _ = p + u, x = d + c / 2, v = p + u / 2;
        ...
        if (0 !== s) {
            ...
            for (var n = 0; 1 > n; n++) {
                var r = t.graphicsData[n], o = r.points;
                if (r.type === e.Graphics.POLY) {
                    i.beginPath(), i.moveTo(o[0], o[1]);
                    for (var a = 1; a < o.length / 2; a++)
                        i.lineTo(o[2 * a], o[2 * a + 1]);
                    o[0] === o[o.length - 2] && o[1] === o[o.length - 1] && i.closePath()
                } else if (r.type === e.Graphics.RECT)
                    i.beginPath(), i.rect(o[0], o[1], o[2], o[3]), i.closePath();
                else if (r.type === e.Graphics.CIRC)
                    i.beginPath(), i.arc(o[0], o[1], o[2], 0, 2 * Math.PI), i.closePath();
                else if (r.type === e.Graphics.ELIP) {
                    var h = r.points, l = 2 * h[2], c = 2 * h[3], u = h[0] - l / 2, d = h[1] - c / 2;
                    i.beginPath();
                    var p = .5522848, f = l / 2 * p, g = c / 2 * p, m = u + l, y = d + c, _ = u + l / 2, x = d + c / 2;
        ...
        do
            if (i = t.worldTransform, t.visible)
                if (t.renderable) {
                    ...
                    } else if (t instanceof e.Strip)
                        s.setTransform(i[0], i[3], i[1], i[4], i[2], i[5]), this.renderStrip(t);
                    else if (t instanceof e.TilingSprite)
                        s.setTransform(i[0], i[3], i[1], i[4], i[2], i[5]), this.renderTilingSprite(t);
                    else if (t instanceof e.CustomRenderable)
                        s.setTransform(i[0], i[3], i[1], i[4], i[2], i[5]), t.renderCanvas(this);
                    else if (t instanceof e.Graphics)
                        s.setTransform(i[0], i[3], i[1], i[4], i[2], i[5]), e.CanvasGraphics.renderGraphics(t, s);
                    else if (t instanceof e.FilterBlock && t.data instanceof e.Graphics) {
                        var o = t.data;
                        if (t.open) {
                            s.save();
                            var a = o.alpha, h = o.worldTransform;
        ...
        var e = this.context, i = t.verticies, s = i.length / 2;
        this.count++, e.beginPath();
        for (var n = 1; s - 2 > n; n++) {
            var r = 2 * n, o = i[r], a = i[r + 2], h = i[r + 4], l = i[r + 1], c = i[r + 3], u = i[r + 5];
        ...
        var i = t.tilePosition, s = t.tileScale;
        ...
        var e = this.context, i = t.verticies, s = t.uvs, n = i.length / 2;
        this.count++;
        for (var r = 1; n - 2 > r; r++) {
            var o = 2 * r, a = i[o], h = i[o + 2], l = i[o + 4], c = i[o + 1], u = i[o + 3], d = i[o + 5], p = s[o] * t.texture.width, f = s[o + 2] * t.texture.width, g = s[o + 4] * t.texture.width, m = s[o + 1] * t.texture.height, y = s[o + 3] * t.texture.height, _ = s[o + 5] * t.texture.height;
            e.save(), e.beginPath(), e.moveTo(a, c), e.lineTo(h, u), e.lineTo(l, d), e.closePath(), e.clip();
            var x = p * y + m * g + f * _ - y * g - m * f - p * _, v = a * y + m * l + h * _ - y * l - m * h - a * _, b = p * h + a * g + f * l - h * g - a * f - p * l, w = p * y * l + m * h * g + a * f * _ - a * y * g - m * f * l - p * h * _, T = c * y + m * d + u * _ - y * d - m * u - c * _, S = p * u + c * g + f * d - u * g - c * f - p * d, C = p * y * d + m * u * g + c * f * _ - c * y * g - m * f * d - p * u * _;
        ...
        var t = e.compileProgram(this.vertexSrc || e.PixiShader.defaultVertexSrc, this.fragmentSrc), i = e.gl;
        ...
        for (var s in this.uniforms)
            this.uniforms[s].uniformLocation = i.getUniformLocation(t, s);
        ...
        if (t.value && t.value.baseTexture && t.value.baseTexture.hasLoaded) {
            if (e.gl.activeTexture(e.gl["TEXTURE" + this.textureCount]), e.gl.bindTexture(e.gl.TEXTURE_2D, t.value.baseTexture._glTexture), t.textureData) {
                var i = t.textureData, s = i.magFilter ? i.magFilter : e.gl.LINEAR, n = i.minFilter ? i.minFilter : e.gl.LINEAR, r = i.wrapS ? i.wrapS : e.gl.CLAMP_TO_EDGE, o = i.wrapT ? i.wrapT : e.gl.CLAMP_TO_EDGE, a = i.luminance ? e.gl.LUMINANCE : e.gl.RGBA;
                if (i.repeat && (r = e.gl.REPEAT, o = e.gl.REPEAT), e.gl.pixelStorei(e.gl.UNPACK_FLIP_Y_WEBGL, !1), i.width) {
                    ...
                    e.gl.texImage2D(e.gl.TEXTURE_2D, 0, a, e.gl.RGBA, e.gl.UNSIGNED_BYTE, t.value.baseTexture.source);
        ...
        var t = e.compileProgram(this.vertexSrc, this.fragmentSrc), i = e.gl;
        ...
        for (var i = 0; i < e._batchs.length; i++)
            e._batchs[i].restoreLostContext(t)
        ...
        for (var t, e, i = 0, s = this.head; s; ) {
            t = 8 * i;
            var n = s.texture, r = n.frame, o = n.baseTexture.width, a = n.baseTexture.height;
        ...
        for (var t, i, s, n, r, o, a, h, l, c, u, d, p, f, g, m, y = 0, _ = this.head, x = this.verticies, v = this.uvs, b = this.colors; _; ) {
            if (_.vcount === e.visibleCount) {
                if (i = _.texture.frame.width, s = _.texture.frame.height, n = _.anchor.x, r = _.anchor.y, o = i * (1 - n), a = i * -n, h = s * (1 - r), l = s * -r, c = 8 * y, t = _.worldTransform, u = t[0], d = t[3], p = t[1], f = t[4], g = t[2], m = t[5], x[c + 0] = u * a + p * l + g, x[c + 1] = f * l + d * a + m, x[c + 2] = u * o + p * l + g, x[c + 3] = f * l + d * o + m, x[c + 4] = u * o + p * h + g, x[c + 5] = f * h + d * o + m, x[c + 6] = u * a + p * h + g, x[c + 7] = f * h + d * a + m, _.updateFrame || _.texture.updateFrame) {
                    this.dirtyUVS = !0;
                    var w = _.texture, T = w.frame, S = w.baseTexture.width, C = w.baseTexture.height;
        ...
        var r = t.target.filterArea, o = s.padding;
        ...
        var t = e.gl, i = this.filterStack.pop(), s = i.target.filterArea, n = i._glFilterTexture;
        if (i.filterPasses.length > 1) {
            ...
            var r = n, o = this.texturePool.pop();
        ...
        var u = this.width, d = this.height, p = 0, f = 0, g = this.buffer;
        ...
        var i, s, n, r, o, a, h, l, c, u, d, p, f, g, m, y, _, x, v, b, w, T, S, C, A = t.first, P = t.last._iNext, R = -1 / 0, E = -1 / 0, L = 1 / 0, O = 1 / 0;
        do {
            if (A.visible)
                if (A instanceof e.Sprite)
                    s = A.texture.frame.width, n = A.texture.frame.height, r = A.anchor.x, o = A.anchor.y, a = s * (1 - r), h = s * -r, l = n * (1 - o), c = n * -o, u = !0;
        ...
        var s = e.gl;
        t._webGL || (t._webGL = {points: [],indices: [],lastIndex: 0,buffer: s.createBuffer(),indexBuffer: s.createBuffer()}), t.dirty && (t.dirty = !1, t.clearDirty && (t.clearDirty = !1, t._webGL.lastIndex = 0, t._webGL.points = [], t._webGL.indices = []), e.WebGLGraphics.updateGraphics(t)), e.activatePrimitiveShader();
        ...
        var s = t.points, n = s[0], r = s[1], o = s[2], a = s[3];
        if (t.fill) {
            var h = e.hex2rgb(t.fillColor), l = t.fillAlpha, c = h[0] * l, u = h[1] * l, d = h[2] * l, p = i.points, f = i.indices, g = p.length / 6;
        ...
        var s = t.points, n = s[0], r = s[1], o = s[2], a = s[3], h = 40, l = 2 * Math.PI / h, c = 0;
        if (t.fill) {
            var u = e.hex2rgb(t.fillColor), d = t.fillAlpha, p = u[0] * d, f = u[1] * d, g = u[2] * d, m = i.points, y = i.indices, _ = m.length / 6;
            for (y.push(_), c = 0; h + 1 > c; c++)
                m.push(n, r, p, f, g, d), m.push(n + Math.sin(l * c) * o, r + Math.cos(l * c) * a, p, f, g, d), y.push(_++, _++);
            y.push(_ - 1)
        }
        if (t.lineWidth) {
            for (t.points = [], c = 0; h + 1 > c; c++)
                t.points.push(n + Math.sin(l * c) * o, r + Math.cos(l * c) * a);
        ...
        if (0 !== n.length) {
            if (t.lineWidth % 2)
                for (s = 0; s < n.length; s++)
                    n[s] += .5;
            var r = new e.Point(n[0], n[1]), o = new e.Point(n[n.length - 2], n[n.length - 1]);
            if (r.x === o.x && r.y === o.y) {
                n.pop(), n.pop(), o = new e.Point(n[n.length - 2], n[n.length - 1]);
                var a = o.x + .5 * (r.x - o.x), h = o.y + .5 * (r.y - o.y);
                n.unshift(a, h), n.push(a, h)
            }
            var l, c, u, d, p, f, g, m, y, _, x, v, b, w, T, S, C, A, P, R, E, L, O, D = i.points, k = i.indices, F = n.length / 2, M = n.length, I = D.length / 6, B = t.lineWidth / 2, G = e.hex2rgb(t.lineColor), U = t.lineAlpha, N = G[0] * U, j = G[1] * U, W = G[2] * U;
            for (u = n[0], d = n[1], p = n[2], f = n[3], y = -(d - f), _ = u - p, O = Math.sqrt(y * y + _ * _), y /= O, _ /= O, y *= B, _ *= B, D.push(u - y, d - _, N, j, W, U), D.push(u + y, d + _, N, j, W, U), s = 1; F - 1 > s; s++)
                u = n[2 * (s - 1)], d = n[2 * (s - 1) + 1], p = n[2 * s], f = n[2 * s + 1], g = n[2 * (s + 1)], m = n[2 * (s + 1) + 1], y = -(d - f), _ = u - p, O = Math.sqrt(y * y + _ * _), y /= O, _ /= O, y *= B, _ *= B, x = -(f - m), v = p - g, O = Math.sqrt(x * x + v * v), x /= O, v /= O, x *= B, v *= B, T = -_ + d - (-_ + f), S = -y + p - (-y + u), C = (-y + u) * (-_ + f) - (-y + p) * (-_ + d), A = -v + m - (-v + f), P = -x + p - (-x + g), R = (-x + g) * (-v + f) - (-x + p) * (-v + m), E = T * P - A * S, Math.abs(E) < .1 ? (E += 10.1, D.push(p - y, f - _, N, j, W, U), D.push(p + y, f + _, N, j, W, U)) : (l = (S * R - P * C) / E, c = (A * C - T * R) / E, L = (l - p) * (l - p) + (c - f) + (c - f), L > 19600 ? (b = y - x, w = _ - v, O = Math.sqrt(b * b + w * w), b /= O, w /= O, b *= B, w *= B, D.push(p - b, f - w), D.push(N, j, W, U), D.push(p + b, f + w), D.push(N, j, W, U), D.push(p - b, f - w), D.push(N, j, W, U), M++) : (D.push(l, c), D.push(N, j, W, U), D.push(p - (l - p), f - (c - f)), D.push(N, j, W, U)));
            for (u = n[2 * (F - 2)], d = n[2 * (F - 2) + 1], p = n[2 * (F - 1)], f = n[2 * (F - 1) + 1], y = -(d - f), _ = u - p, O = Math.sqrt(y * y + _ * _), y /= O, _ /= O, y *= B, _ *= B, D.push(p - y, f - _), D.push(N, j, W, U), D.push(p + y, f + _), D.push(N, j, W, U), k.push(I), s = 0; M > s; s++)
                k.push(I++);
            k.push(I - 1)
        }
        ...
        var s = t.points;
        if (!(s.length < 6)) {
            var n = i.points, r = i.indices, o = s.length / 2, a = e.hex2rgb(t.fillColor), h = t.fillAlpha, l = a[0] * h, c = a[1] * h, u = a[2] * h, d = e.PolyK.Triangulate(s), p = n.length / 6, f = 0;
            for (f = 0; f < d.length; f += 3)
                r.push(d[f] + p), r.push(d[f] + p), r.push(d[f + 1] + p), r.push(d[f + 2] + p), r.push(d[f + 2] + p);
            for (f = 0; o > f; f++)
                n.push(s[2 * f], s[2 * f + 1], l, c, u, h)
        }
        ...
        if (!this.contextLost) {
            ...
            if (i.colorMask(!0, !0, !0, this.transparent), i.viewport(0, 0, this.width, this.height), i.bindFramebuffer(i.FRAMEBUFFER, null), i.clearColor(t.backgroundColorSplit[0], t.backgroundColorSplit[1], t.backgroundColorSplit[2], !this.transparent), i.clear(i.COLOR_BUFFER_BIT), this.stageRenderGroup.backgroundColor = t.backgroundColorSplit, e.projection.x = this.width / 2, e.projection.y = -this.height / 2, this.stageRenderGroup.render(e.projection), t.interactive && (t._interactiveEventsAdded || (t._interactiveEventsAdded = !0, t.interactionManager.setTarget(this))), e.Texture.frameUpdates.length > 0) {
                for (var s = 0; s < e.Texture.frameUpdates.length; s++)
                    e.Texture.frameUpdates[s].updateFrame = !1;
                e.Texture.frameUpdates = []
            }
        }
    }, e.WebGLRenderer.updateTextures = function() {
        var t = 0;
        for (t = 0; t < e.texturesToUpdate.length; t++)
            e.WebGLRenderer.updateTexture(e.texturesToUpdate[t]);
        ...
        for (var s = 0; s < this.batchs.length; s++)
            this.batchs[s].restoreLostContext(this.gl), this.batchs[s].dirty = !0;
        ...
        for (var n, r = 0; r < this.batchs.length; r++)
            n = this.batchs[r], n instanceof e.WebGLBatch ? this.batchs[r].render() : this.renderSpecial(n, t)
        ...
        for (var r, o, a, h, l = t.first; l._iNext && (!l.renderable || !l.__renderGroup); )
            l = l._iNext;
        var c = l.batch;
        if (l instanceof e.Sprite) {
            ...
            c = l;
        for (var d = t.last; d._iPrev && (!d.renderable || !d.__renderGroup); )
            d = d._iNext;
        if (d instanceof e.Sprite) {
            ...
            endBatch = d;
        if (c == endBatch)
            return void (c instanceof e.WebGLBatch ? c.render(r, a + 1) : this.renderSpecial(c, i));
        o = this.batchs.indexOf(c), h = this.batchs.indexOf(endBatch), c instanceof e.WebGLBatch ? c.render(r) : this.renderSpecial(c, i);
        for (var p = o + 1; h > p; p++)
            renderable = this.batchs[p], renderable instanceof e.WebGLBatch ? this.batchs[p].render() : this.renderSpecial(renderable, i);
    ...
    return e.WebGLRenderGroup.prototype.handleFilterBlock = function(t, i) {
        var r = e.gl;
        if (t.open)
            t.data instanceof Array ? this.filterManager.pushFilter(t) : (n++, s.push(t), r.enable(r.STENCIL_TEST), r.colorMask(!1, !1, !1, !1), r.stencilFunc(r.ALWAYS, 1, 1), r.stencilOp(r.KEEP, r.KEEP, r.INCR), e.WebGLGraphics.renderGraphics(t.data, i), r.colorMask(!0, !0, !0, !0), r.stencilFunc(r.NOTEQUAL, 0, s.length), r.stencilOp(r.KEEP, r.KEEP, r.KEEP));
        ...
        for (var i = t.last; i._iNext && (i = i._iNext, !i.renderable || !i.__renderGroup); )
            ;
        var s = t.first, n = t.last._iNext;
        do
            s.__renderGroup = this, s.renderable && (this.insertObject(s, e, i), e = s), s = s._iNext;
        while (s != n)
        ...
        if (t instanceof e.Sprite) {
            ...
            if (n instanceof e.Sprite) {
                if (o = n.batch, o && o.texture == t.texture.baseTexture && o.blendMode == t.blendMode)
                    return void o.insertAfter(t, n)
            } else
                o = n;
            if (r)
                if (r instanceof e.Sprite) {
                    if (a = r.batch) {
                        if (a.texture == t.texture.baseTexture && a.blendMode == t.blendMode)
                            return void a.insertBefore(t, r);
                        if (a == o) {
                            var h = o.split(r), l = e.WebGLRenderer.getBatch(), c = this.batchs.indexOf(o);
            ...
            t instanceof e.TilingSprite ? this.initTilingSprite(t) : t instanceof e.Strip && this.initStrip(t), this.insertAfter(t, n)
        ...
        if (i instanceof e.Sprite) {
            ...
            if (s)
                if (s.tail == i) {
                    ...
                    var r = s.split(i.__next), n = this.batchs.indexOf(s);
        ...
        if (i) {
            ...
            if (-1 == n)
                return;
            if (0 == n || n == this.batchs.length - 1)
                return this.batchs.splice(n, 1), void (i instanceof e.WebGLBatch && e.WebGLRenderer.returnBatch(i));
        ...
        var n = e.stripShader, r = (n.program, e.mat3.clone(t.worldTransform));
        ...
        var s = this.gl, n = (e.shaderProgram, t.tilePosition), r = t.tileScale, o = n.x / t.texture.baseTexture.width, a = n.y / t.texture.baseTexture.height, h = t.width / t.texture.baseTexture.width / r.x, l = t.height / t.texture.baseTexture.height / r.y;
        ...
        var t = e.gl, i = e.defaultShader.program;
        ...
        var s = e.gl, n = e.CompileFragmentShader(s, i), r = e.CompileVertexShader(s, t), o = s.createProgram();
        ...
        for (var t = e.BitmapText.fonts[this.fontName], i = new e.Point, s = null, n = [], r = 0, o = [], a = 0, h = this.fontSize / t.size, l = 0; l < this.text.length; l++) {
            ...
            if (/(?:\r\n|\r|\n)/.test(this.text.charAt(l)))
                o.push(i.x), r = Math.max(r, i.x), a++, i.x = 0, i.y += t.lineHeight, s = null;
            else {
                var u = t.chars[c];
        ...
        if (!i) {
            var s = document.getElementsByTagName("body")[0], n = document.createElement("div"), r = document.createTextNode("M");
        ...
        if (e.EventTarget.call(this), this.width = 100, this.height = 100, this.scaleMode = i || e.BaseTexture.SCALE_MODE.DEFAULT, this.hasLoaded = !1, this.source = t, t) {
            if (this.source instanceof Image || this.source instanceof HTMLImageElement)
                if (this.source.complete)
                    this.hasLoaded = !0, this.width = this.source.width, this.height = this.source.height, e.texturesToUpdate.push(this);
                else {
                    var s = this;
        ...
        return n
    }, e.BaseTexture.SCALE_MODE = {DEFAULT: 0,LINEAR: 0,NEAREST: 1}, e.TextureCache = {}, e.FrameCache = {}, e.Texture = function(t, i) {
        if (e.EventTarget.call(this), i || (this.noFrame = !0, i = new e.Rectangle(0, 0, 1, 1)), t instanceof e.Texture && (t = t.baseTexture), this.baseTexture = t, this.frame = i, this.trim = new e.Point, this.scope = this, t.hasLoaded)
        ...
        t.removeEventListener("loaded", this.onLoaded), this.noFrame && (this.frame = new e.Rectangle(0, 0, t.width, t.height)), this.noFrame = !1, this.width = this.frame.width, this.height = this.frame.height, this.scope.dispatchEvent({type: "update",content: this})
        ...
        var r = t.children, o = t.worldTransform;
        ...
        this.addEventListener = this.on = function(e, i) {
            ...
            if (t[e.type] && t[e.type].length)
                for (var i = 0, s = t[e.type].length; s > i; i++)
                    t[e.type][i](e)
        ...
        var i = !0, s = t.length >> 1;
        if (3 > s)
            return [];
        for (var n = [], r = [], o = 0; s > o; o++)
            r.push(o);
        o = 0;
        for (var a = s; a > 3; ) {
            var h = r[(o + 0) % a], l = r[(o + 1) % a], c = r[(o + 2) % a], u = t[2 * h], d = t[2 * h + 1], p = t[2 * l], f = t[2 * l + 1], g = t[2 * c], m = t[2 * c + 1], y = !1;
            ...
            if (y)
                n.push(h, l, c), r.splice((o + 1) % a, 1), a--, o = 0;
            else if (o++ > 3 * a) {
                if (!i)
        ...
        var h = o - i, l = a - s, c = n - i, u = r - s, d = t - i, p = e - s, f = h * h + l * l, g = h * c + l * u, m = h * d + l * p, y = c * c + u * u, _ = c * d + u * p, x = 1 / (f * y - g * g), v = (y * m - g * _) * x, b = (f * _ - g * m) * x;
        return v >= 0 && b >= 0 && 1 > v + b
    }, e.PolyK._convex = function(t, e, i, s, n, r, o) {
        return (e - s) * (n - i) + (i - t) * (r - s) >= 0 === o
    }, i.Camera = function(t, e, s, n, r, o) {
        this.game = t, this.world = t.world, this.id = 0, this.view = new i.Rectangle(s, n, r, o), this.screenView = new i.Rectangle(s, n, r, o), this.bounds = new i.Rectangle(s, n, r, o), this.deadzone = null, this.visible = !0, this.atLimit = {x: !1,y: !1}, this.target = null, this._edge = 0, this.displayObject = null
    }, i.Camera.FOLLOW_LOCKON = 0, i.Camera.FOLLOW_PLATFORMER = 1, i.Camera.FOLLOW_TOPDOWN = 2, i.Camera.FOLLOW_TOPDOWN_TIGHT = 3, i.Camera.prototype = {follow: function(t, e) {
            "undefined" == typeof e && (e = i.Camera.FOLLOW_LOCKON), this.target = t;
            var s;
            switch (e) {
                case i.Camera.FOLLOW_PLATFORMER:
                    var n = this.width / 8, r = this.height / 3;
        ...
        }}, i.Camera.prototype.constructor = i.Camera, Object.defineProperty(i.Camera.prototype, "x", {get: function() {
            return this.view.x
        },set: function(t) {
            this.view.x = t, this.bounds && this.checkBounds()
        }}), Object.defineProperty(i.Camera.prototype, "y", {get: function() {
            return this.view.y
        },set: function(t) {
            this.view.y = t, this.bounds && this.checkBounds()
        }}), Object.defineProperty(i.Camera.prototype, "width", {get: function() {
            return this.view.width
        },set: function(t) {
            this.view.width = t
        }}), Object.defineProperty(i.Camera.prototype, "height", {get: function() {
    ...
    }, i.State.prototype = {preload: function() {
        },loadUpdate: function() {
        },loadRender: function() {
        },create: function() {
        },update: function() {
    ...
    }, i.StateManager.prototype = {boot: function() {
    ...
    }, i.LinkedList.prototype = {add: function(t) {
        ...
        this.dispatch = function() {
    ...
    }, i.Signal.prototype = {memorize: !1,_shouldPropagate: !0,active: !0,validateListener: function(t, e) {
            ...
            for (var i, s = this._bindings.length; s--; )
                if (i = this._bindings[s], i._listener === t && i.context === e)
                    return s;
            return -1
        },has: function(t, e) {
    ...
    }, i.SignalBinding.prototype = {active: !0,params: null,execute: function(t) {
            var e, i;
        ...
        this.game = t, this.type = i.WEBGL_FILTER, this.passes = [this], this.dirty = !0, this.padding = 0, this.uniforms = {time: {type: "1f",value: 0},resolution: {type: "2f",value: {x: 256,y: 256}},mouse: {type: "2f",value: {x: 0,y: 0}}}, this.fragmentSrc = s || []
    }, i.Filter.prototype = {init: function() {
            ...
            this.game = null
        }}, i.Filter.prototype.constructor = i.Filter, Object.defineProperty(i.Filter.prototype, "width", {get: function() {
            return this.uniforms.resolution.value.x
        },set: function(t) {
            this.uniforms.resolution.value.x = t
        }}), Object.defineProperty(i.Filter.prototype, "height", {get: function() {
    ...
    }, i.Plugin.prototype = {preUpdate: function() {
        },update: function() {
        },render: function() {
        },postRender: function() {
        },destroy: function() {
        ...
        this.game = t, this._parent = e, this.plugins = [], this._pluginsLength = 0
    }, i.PluginManager.prototype = {add: function(t) {
            var e = !1;
            ...
            if (0 !== this._pluginsLength)
                for (this._p = 0; this._p < this._pluginsLength; this._p++)
                    if (this.plugins[this._p] === t)
                        return t.destroy(), this.plugins.splice(this._p, 1), void this._pluginsLength--
        },removeAll: function() {
            for (this._p = 0; this._p < this._pluginsLength; this._p++)
        ...
        }}, i.Stage.prototype.constructor = i.Stage, Object.defineProperty(i.Stage.prototype, "backgroundColor", {get: function() {
        ...
        this.game = t, "undefined" == typeof s && (s = t.world), this.name = n || "group", "undefined" == typeof r && (r = !1), r ? this._container = this.game.stage._stage : (this._container = new e.DisplayObjectContainer, this._container.name = this.name, s ? s instanceof i.Group ? s._container.addChild(this._container) : (s.addChild(this._container), s.updateTransform()) : (this.game.stage._stage.addChild(this._container), this.game.stage._stage.updateTransform())), this.type = i.GROUP, this.alive = !0, this.exists = !0, this.group = null, this._container.scale = new i.Point(1, 1), this.scale = this._container.scale, this.pivot = this._container.pivot, this.cursor = null
    }, i.Group.RETURN_NONE = 0, i.Group.RETURN_TOTAL = 1, i.Group.RETURN_CHILD = 2, i.Group.SORT_ASCENDING = -1, i.Group.SORT_DESCENDING = 1, i.Group.prototype = {add: function(t) {
            ...
            var i = this.getAt(t), s = this.getAt(e);
            this.swap(i, s)
        },swap: function(t, e) {
            if (t === e || !t.parent || !e.parent || t.group !== this || e.group !== this)
                return !1;
            var i = t._iPrev, s = t._iNext, n = e._iPrev, r = e._iNext, o = this._container.last._iNext, a = this.game.stage._stage;
            do
                a !== t && a !== e && (a.first === t ? a.first = e : a.first === e && (a.first = t), a.last === t ? a.last = e : a.last === e && (a.last = t)), a = a._iNext;
            while (a != o);
            ...
            if (this._container.first._iNext) {
                ...
                -1 != i && (void 0 !== e.parent && (e.events.onRemovedFromGroup.dispatch(e, this), e.parent.removeChild(e)), this._container.removeChild(t), this._container.addChildAt(e, i), e.events.onAddedToGroup.dispatch(e, this), e.updateTransform(), this.cursor == t && (this.cursor = this._container._iNext))
            }
            ...
            if (t = t.split("."), "undefined" == typeof i && (i = !1), "undefined" == typeof s && (s = !1), n = n || 0, this._container.children.length > 0 && this._container.first._iNext) {
                ...
                do
                    (i === !1 || i && r.alive) && (s === !1 || s && r.visible) && this.setProperty(r, t, e, n), r = r._iNext;
            ...
            if (this._container.children.length > 0 && this._container.first._iNext) {
                ...
                do
                    s.exists == e && s[t] && s[t].apply(s, i), s = s._iNext;
            ...
            if ("undefined" != typeof t) {
                ...
                var n = Array.prototype.splice.call(arguments, 2), r = null, o = null;
                if (this._container.children.length > 0 && this._container.first._iNext) {
                    var a = this._container.first._iNext;
                    do
                        r = this.callbackFromArray(a, t, i), e && r ? (o = this.callbackFromArray(a, e, s), r && r.apply(o, n)) : r && r.apply(a, n), a = a._iNext;
            ...
            if (s.unshift(null), this._container.children.length > 0 && this._container.first._iNext) {
                ...
                do
                    (i === !1 || i && n.exists) && (s[0] = n, t.apply(e, s)), n = n._iNext;
            ...
            do {
                ...
                for (var r = 0, o = this._container.children.length - 1; o > r; r++)
                    e == i.Group.SORT_ASCENDING ? this._container.children[r][t] > this._container.children[r + 1][t] && (this.swap(this.getAt(r), this.getAt(r + 1)), n = this._container.children[r], this._container.children[r] = this._container.children[r + 1], this._container.children[r + 1] = n, s = !0) : this._container.children[r][t] < this._container.children[r + 1][t] && (this.swap(this.getAt(r), this.getAt(r + 1)), n = this._container.children[r], this._container.children[r] = this._container.children[r + 1], this._container.children[r + 1] = n, s = !0)
            } while (s)
        },iterate: function(t, e, s, n, r, o) {
            if (s === i.Group.RETURN_TOTAL && 0 === this._container.children.length)
                return 0;
            "undefined" == typeof n && (n = !1);
            var a = 0;
            if (this._container.children.length > 0 && this._container.first._iNext) {
                ...
                do {
                    if (h[t] === e && (a++, n && (o[0] = h, n.apply(r, o)), s === i.Group.RETURN_CHILD))
                        return h;
                    h = h._iNext
            ...
            if (0 !== this._container.children.length) {
                if (t > e || 0 > t || e > this._container.children.length)
                    return !1;
                for (var i = t; e > i; i++) {
            ...
            var t = this.game.stage._stage.last._iNext, e = this.game.stage._stage, i = null, s = null, n = 0;
            do {
                if (n > 0) {
                    if (e !== i)
            ...
            return !0
        }}, i.Group.prototype.constructor = i.Group, Object.defineProperty(i.Group.prototype, "total", {get: function() {
            return this._container ? this.iterate("exists", !0, i.Group.RETURN_TOTAL) : 0
        }}), Object.defineProperty(i.Group.prototype, "length", {get: function() {
            return this._container ? this._container.children.length : 0
        }}), Object.defineProperty(i.Group.prototype, "x", {get: function() {
            return this._container.position.x
        },set: function(t) {
            this._container.position.x = t
        }}), Object.defineProperty(i.Group.prototype, "y", {get: function() {
            return this._container.position.y
        },set: function(t) {
            this._container.position.y = t
        }}), Object.defineProperty(i.Group.prototype, "angle", {get: function() {
            return i.Math.radToDeg(this._container.rotation)
        },set: function(t) {
            this._container.rotation = i.Math.degToRad(t)
        }}), Object.defineProperty(i.Group.prototype, "rotation", {get: function() {
            return this._container.rotation
        },set: function(t) {
            this._container.rotation = t
        }}), Object.defineProperty(i.Group.prototype, "visible", {get: function() {
            return this._container.visible
        },set: function(t) {
            this._container.visible = t
        }}), Object.defineProperty(i.Group.prototype, "alpha", {get: function() {
        ...
        if (this.game.stage._stage.first._iNext) {
            ...
            do
                t = t.preUpdate && !t.preUpdate() ? t.last._iNext : t._iNext;
        ...
        if (this.currentRenderOrderID = 0, this.game.stage._stage.first._iNext) {
            var t = this.game.stage._stage.first._iNext;
            do
                t = t.update && !t.update() ? t.last._iNext : t._iNext;
            while (t != this.game.stage._stage.last._iNext)
        }
        ...
        if (this.camera.target && this.camera.target.postUpdate) {
            if (this.camera.target.postUpdate(), this.camera.update(), this.game.stage._stage.first._iNext) {
                var t = this.game.stage._stage.first._iNext;
                do
                    t.postUpdate && t !== this.camera.target && t.postUpdate(), t = t._iNext;
                while (t != this.game.stage._stage.last._iNext)
            }
        } else if (this.camera.update(), this.game.stage._stage.first._iNext) {
            var t = this.game.stage._stage.first._iNext;
            do
                t.postUpdate && t.postUpdate(), t = t._iNext;
            while (t != this.game.stage._stage.last._iNext)
        }
    ...
    }, Object.defineProperty(i.World.prototype, "width", {get: function() {
            return this.bounds.width
        },set: function(t) {
            this.bounds.width = t
        }}), Object.defineProperty(i.World.prototype, "height", {get: function() {
            return this.bounds.height
        },set: function(t) {
            this.bounds.height = t
        }}), Object.defineProperty(i.World.prototype, "centerX", {get: function() {
            return this.bounds.halfWidth
        }}), Object.defineProperty(i.World.prototype, "centerY", {get: function() {
            return this.bounds.halfHeight
        }}), Object.defineProperty(i.World.prototype, "randomX", {get: function() {
        ...
        }}), Object.defineProperty(i.World.prototype, "randomY", {get: function() {
        ...
        }}), Object.defineProperty(i.World.prototype, "visible", {get: function() {
            return this._container.visible
        },set: function(t) {
            this._container.visible = t
        ...
        return this._onBoot = function() {
    ...
    }, i.Game.prototype = {parseConfig: function(t) {
            ...
            var t = i.DEV_VERSION, e = "Canvas", s = "HTML Audio";
            if (this.renderType == i.WEBGL ? e = "WebGL" : this.renderType == i.HEADLESS && (e = "Headless"), this.device.webAudio && (s = "WebAudio"), this.device.chrome) {
                ...
                console.log("Phaser v" + t + " - Renderer: " + e + " - Audio: " + s)
            ...
            if (this.renderType === i.HEADLESS || this.renderType === i.CANVAS || this.renderType === i.AUTO && this.device.webGL === !1) {
                ...
                this.renderType = i.WEBGL, this.renderer = new e.WebGLRenderer(this.width, this.height, this.stage.canvas, this.transparent, this.antialias), this.canvas = this.renderer.view, this.context = null;
        ...
        }}, i.Game.prototype.constructor = i.Game, Object.defineProperty(i.Game.prototype, "paused", {get: function() {
            return this._paused
        },set: function(t) {
        ...
        this.game = t, this.hitCanvas = null, this.hitContext = null, this.moveCallback = null, this.moveCallbackContext = this
            ...
            for (var t = 0, e = 10; e > 0; e--)
                null === this["pointer" + e] && (t = e);
            ...
            if (this.game.isBooted !== !1) {
                ...
                for (var e = 1; 10 >= e; e++)
                    this["pointer" + e] && this["pointer" + e].reset();
            ...
            for (var e = 3; 10 >= e; e++)
                if (this["pointer" + e] && this["pointer" + e].active === !1)
                    return this["pointer" + e].start(t);
            return null
            ...
            for (var e = 3; 10 >= e; e++)
                if (this["pointer" + e] && this["pointer" + e].active && this["pointer" + e].identifier == t.identifier)
                    return this["pointer" + e].move(t);
            return null
            ...
            for (var e = 3; 10 >= e; e++)
                if (this["pointer" + e] && this["pointer" + e].active && this["pointer" + e].identifier == t.identifier)
                    return this["pointer" + e].stop(t);
            return null
        },getPointer: function(t) {
            if (t = t || !1, this.pointer1.active == t)
                return this.pointer1;
            if (this.pointer2.active == t)
                return this.pointer2;
            for (var e = 3; 10 >= e; e++)
                if (this["pointer" + e] && this["pointer" + e].active == t)
                    return this["pointer" + e];
            return null
        },getPointerFromIdentifier: function(t) {
            if (this.pointer1.identifier == t)
                return this.pointer1;
            if (this.pointer2.identifier == t)
                return this.pointer2;
            for (var e = 3; 10 >= e; e++)
                if (this["pointer" + e] && this["pointer" + e].identifier == t)
                    return this["pointer" + e];
            return null
        }}, i.Input.prototype.constructor = i.Input, Object.defineProperty(i.Input.prototype, "x", {get: function() {
            return this._x
        },set: function(t) {
            this._x = Math.floor(t)
        }}), Object.defineProperty(i.Input.prototype, "y", {get: function() {
            return this._y
        },set: function(t) {
            this._y = Math.floor(t)
        }}), Object.defineProperty(i.Input.prototype, "pollLocked", {get: function() {
            return this.pollRate > 0 && this._pollCounter < this.pollRate
        }}), Object.defineProperty(i.Input.prototype, "totalInactivePointers", {get: function() {
            return 10 - this.currentPointers
        }}), Object.defineProperty(i.Input.prototype, "totalActivePointers", {get: function() {
            this.currentPointers = 0;
            for (var t = 1; 10 >= t; t++)
                this["pointer" + t] && this["pointer" + t].active && this.currentPointers++;
            return this.currentPointers
        }}), Object.defineProperty(i.Input.prototype, "worldX", {get: function() {
            return this.game.camera.view.x + this.x
        }}), Object.defineProperty(i.Input.prototype, "worldY", {get: function() {
    ...
    }, i.Key.prototype = {processKeyDown: function(t) {
        ...
        this.game = t, this._keys = {}, this._hotkeys = {}, this._capture = {}, this.disabled = !1, this._onKeyDown = null, this._onKeyUp = null, this.callbackContext = this, this.onDownCallback = null, this.onUpCallback = null
    }, i.Keyboard.prototype = {addCallbacks: function(t, e, i) {
            ...
            for (var t in this._keys)
                this._keys[t].isDown = !1
    ...
    }, i.Mouse.NO_BUTTON = -1, i.Mouse.LEFT_BUTTON = 0, i.Mouse.MIDDLE_BUTTON = 1, i.Mouse.RIGHT_BUTTON = 2, i.Mouse.prototype = {start: function() {
            var t = this;
    ...
    }, i.MSPointer.prototype = {start: function() {
            var t = this;
        ...
        this.game = t, this.id = e, this._holdSent = !1, this._history = [], this._nextDrop = 0, this._stateReset = !1, this.withinGame = !1, this.clientX = -1, this.clientY = -1, this.pageX = -1, this.pageY = -1, this.screenX = -1, this.screenY = -1, this.x = -1, this.y = -1, this.isMouse = !1, this.isDown = !1, this.isUp = !0, this.timeDown = 0, this.timeUp = 0, this.previousTapTime = 0, this.totalTouches = 0, this.msSinceLastClick = Number.MAX_VALUE, this.targetObject = null, this.active = !1, this.position = new i.Point, this.positionDown = new i.Point, this.circle = new i.Circle(0, 0, 44), 0 === e && (this.isMouse = !0)
    }, i.Pointer.prototype = {start: function(t) {
            ...
            if (!this.game.input.pollLocked) {
                ...
                if (this._highestRenderOrderID = -1, this._highestRenderObject = null, this._highestInputPriorityID = -1, this.game.input.interactiveItems.total > 0) {
                    ...
                    do
                        (e.pixelPerfect || e.priorityID > this._highestInputPriorityID || e.priorityID == this._highestInputPriorityID && e.sprite.renderOrderID > this._highestRenderOrderID) && e.checkPointerOver(this) && (this._highestRenderOrderID = e.sprite.renderOrderID, this._highestInputPriorityID = e.priorityID, this._highestRenderObject = e), e = e.next;
                    while (null != e)
                }
            ...
            if (this.timeUp = this.game.time.now, (this.game.input.multiInputOverride == i.Input.MOUSE_OVERRIDES_TOUCH || this.game.input.multiInputOverride == i.Input.MOUSE_TOUCH_COMBINE || this.game.input.multiInputOverride == i.Input.TOUCH_OVERRIDES_MOUSE && 0 === this.game.input.currentPointers) && (this.game.input.onUp.dispatch(this, t), this.duration >= 0 && this.duration <= this.game.input.tapRate && (this.timeUp - this.previousTapTime < this.game.input.doubleTapRate ? this.game.input.onTap.dispatch(this, !0) : this.game.input.onTap.dispatch(this, !1), this.previousTapTime = this.timeUp)), this.id > 0 && (this.active = !1), this.withinGame = !1, this.isDown = !1, this.isUp = !0, this.isMouse === !1 && this.game.input.currentPointers--, this.game.input.interactiveItems.total > 0) {
                var e = this.game.input.interactiveItems.next;
                do
                    e && e._releasedHandler(this), e = e.next;
                while (null != e)
            }
        ...
        }}, i.Pointer.prototype.constructor = i.Pointer, Object.defineProperty(i.Pointer.prototype, "duration", {get: function() {
            return this.isUp ? -1 : this.game.time.now - this.timeDown
        }}), Object.defineProperty(i.Pointer.prototype, "worldX", {get: function() {
            return this.game.world.camera.x + this.x
        }}), Object.defineProperty(i.Pointer.prototype, "worldY", {get: function() {
    ...
    }, i.Touch.prototype = {start: function() {
            var t = this;
        ...
        this.sprite = t, this.game = t.game, this.enabled = !1, this.priorityID = 0, this.useHandCursor = !1, this.isDragged = !1, this.allowHorizontalDrag = !0, this.allowVerticalDrag = !0, this.bringToTop = !1, this.snapOffset = null, this.snapOnDrag = !1, this.snapOnRelease = !1, this.snapX = 0, this.snapY = 0, this.snapOffsetX = 0, this.snapOffsetY = 0, this.pixelPerfect = !1, this.pixelPerfectAlpha = 255, this.draggable = !1, this.boundsRect = null, this.boundsSprite = null, this.consumePointerEvent = !1, this._tempPoint = new i.Point, this._pointerData = [], this._pointerData.push({id: 0,x: 0,y: 0,isDown: !1,isUp: !1,isOver: !1,isOut: !1,timeOver: 0,timeOut: 0,timeDown: 0,timeUp: 0,downDuration: 0,isDragged: !1})
    }, i.InputHandler.prototype = {start: function(t, e) {
            if (t = t || 0, "undefined" == typeof e && (e = !1), this.enabled === !1) {
                ...
                for (var s = 0; 10 > s; s++)
                    this._pointerData[s] = {id: s,x: 0,y: 0,isDown: !1,isUp: !1,isOver: !1,isOut: !1,timeOver: 0,timeOut: 0,timeDown: 0,timeUp: 0,downDuration: 0,isDragged: !1};
            ...
            this.enabled = !1;
            for (var t = 0; 10 > t; t++)
                this._pointerData[t] = {id: t,x: 0,y: 0,isDown: !1,isUp: !1,isOver: !1,isOut: !1,timeOver: 0,timeOut: 0,timeDown: 0,timeUp: 0,downDuration: 0,isDragged: !1}
        },stop: function() {
            ...
            if (this.sprite.texture.baseTexture.source) {
                ...
                if (i.data[3] >= this.pixelPerfectAlpha)
                    return !0
            }
            return !1
        },update: function(t) {
        ...
        this.game = t, this._gamepads = [new i.SinglePad(t, this), new i.SinglePad(t, this), new i.SinglePad(t, this), new i.SinglePad(t, this)], this._gamepadIndexMap = {}, this._rawPads = [], this._active = !1, this.disabled = !1, this._gamepadSupportAvailable = !!navigator.webkitGetGamepads || !!navigator.webkitGamepads || -1 != navigator.userAgent.indexOf("Firefox/"), this._prevRawGamepadTypes = [], this._prevTimestamps = [], this.callbackContext = this, this.onConnectCallback = null, this.onDisconnectCallback = null, this.onDownCallback = null, this.onUpCallback = null, this.onAxisCallback = null, this.onFloatCallback = null, this._ongamepadconnected = null, this._gamepaddisconnected = null
    }, i.Gamepad.prototype = {addCallbacks: function(t, e) {
            ...
            this._ongamepadconnected = function(e) {
                ...
                var i = e.gamepad;
                for (var s in t._rawPads)
                    t._rawPads[s].index === i.index && t._rawPads.splice(s, 1);
            ...
            for (var t = 0; t < this._gamepads.length; t++)
                this._gamepads[t]._connected && this._gamepads[t].pollStatus()
                    ...
                    for (var s, n = {rawIndices: {},padIndices: {}}, r = 0; r < this._gamepads.length; r++)
                        if (s = this._gamepads[r], s.connected)
                            for (var o = 0; o < this._rawPads.length; o++)
                                this._rawPads[o].index === s.index && (n.rawIndices[s.index] = !0, n.padIndices[r] = !0);
            ...
            for (var e = 0; e < this._gamepads.length; e++)
                if (this._gamepads[e].isDown(t) === !0)
                    return !0;
            return !1
        }}, i.Gamepad.prototype.constructor = i.Gamepad, Object.defineProperty(i.Gamepad.prototype, "active", {get: function() {
            return this._active
        }}), Object.defineProperty(i.Gamepad.prototype, "supported", {get: function() {
            return this._gamepadSupportAvailable
        }}), Object.defineProperty(i.Gamepad.prototype, "padsConnected", {get: function() {
            return this._rawPads.length
        }}), Object.defineProperty(i.Gamepad.prototype, "pad1", {get: function() {
            return this._gamepads[0]
        }}), Object.defineProperty(i.Gamepad.prototype, "pad2", {get: function() {
            return this._gamepads[1]
        }}), Object.defineProperty(i.Gamepad.prototype, "pad3", {get: function() {
            return this._gamepads[2]
        }}), Object.defineProperty(i.Gamepad.prototype, "pad4", {get: function() {
        ...
        this.game = t, this._padParent = e, this._index = null, this._rawPad = null, this._connected = !1, this._prevTimestamp = null, this._rawButtons = [], this._buttons = [], this._axes = [], this._hotkeys = [], this.callbackContext = this, this.onConnectCallback = null, this.onDisconnectCallback = null, this.onDownCallback = null, this.onUpCallback = null, this.onAxisCallback = null, this.onFloatCallback = null, this.deadZone = .26
    }, i.SinglePad.prototype = {addCallbacks: function(t, e) {
            "undefined" != typeof e && (this.onConnectCallback = "function" == typeof e.onConnect ? e.onConnect : this.onConnectCallback, this.onDisconnectCallback = "function" == typeof e.onDisconnect ? e.onDisconnect : this.onDisconnectCallback, this.onDownCallback = "function" == typeof e.onDown ? e.onDown : this.onDownCallback, this.onUpCallback = "function" == typeof e.onUp ? e.onUp : this.onUpCallback, this.onAxisCallback = "function" == typeof e.onAxis ? e.onAxis : this.onAxisCallback, this.onFloatCallback = "function" == typeof e.onFloat ? e.onFloat : this.onFloatCallback)
            ...
            for (var e = 0; e < this._axes.length; e++)
                this._axes[e] = 0
        }}, i.SinglePad.prototype.constructor = i.SinglePad, Object.defineProperty(i.SinglePad.prototype, "connected", {get: function() {
            return this._connected
        }}), Object.defineProperty(i.SinglePad.prototype, "index", {get: function() {
            return this._index
    ...
    }, i.GamepadButton.prototype = {processButtonDown: function(t) {
    ...
    }, i.Events.prototype = {destroy: function() {
        ...
        this.game = t, this.world = this.game.world
    }, i.GameObjectFactory.prototype = {existing: function(t) {
            ...
            var e = Array.prototype.splice.call(arguments, 1), t = new i.Filter[t](this.game);
        ...
        "undefined" == typeof s && (s = 256), "undefined" == typeof n && (n = 256), this.game = t, this.name = "", this.width = s, this.height = n, this.canvas = i.Canvas.create(s, n), this.context = this.canvas.getContext("2d"), this.imageData = this.context.getImageData(0, 0, s, n), this.pixels = this.imageData.data.buffer ? this.imageData.data.buffer : this.imageData.data, this.baseTexture = new e.BaseTexture(this.canvas), this.texture = new e.Texture(this.baseTexture), this.textureFrame = new i.Frame(0, 0, 0, s, n, "bitmapData", t.rnd.uuid()), this.type = i.BITMAPDATA, this._dirty = !1
    }, i.BitmapData.prototype = {add: function(t) {
            t.loadTexture(this)
        },addTo: function(t) {
            for (var e = 0; e < t.length; e++)
                t[e].texture && t[e].loadTexture(this)
        },clear: function() {
            ...
            for (var o = this.createLinearGradient(i, s, n, r), a = 0, h = t.length; h > a; a++)
                o.addColorStop(e[a], t[a]);
            ...
            for (var h = this.createRadialGradient(i, s, n, r, o, a), l = 0, c = t.length; c > l; l++)
            ...
            var n = .5522848, r = i / 2 * n, o = s / 2 * n, a = t + i, h = e + s, l = t + i / 2, c = e + s / 2;
    ...
    }, Object.defineProperty(i.Sprite.prototype, "deltaX", {get: function() {
            return this.world.x - this._cache.prevX
        }}), Object.defineProperty(i.Sprite.prototype, "deltaY", {get: function() {
            return this.world.y - this._cache.prevY
        }}), Object.defineProperty(i.Sprite.prototype, "angle", {get: function() {
            return i.Math.wrapAngle(i.Math.radToDeg(this.rotation))
        },set: function(t) {
            this.rotation = i.Math.degToRad(i.Math.wrapAngle(t))
        }}), Object.defineProperty(i.Sprite.prototype, "frame", {get: function() {
            return this.animations.frame
        },set: function(t) {
            this.animations.frame = t
        }}), Object.defineProperty(i.Sprite.prototype, "frameName", {get: function() {
            return this.animations.frameName
        },set: function(t) {
            this.animations.frameName = t
        }}), Object.defineProperty(i.Sprite.prototype, "inCamera", {get: function() {
            return this._cache.cameraVisible
        }}), Object.defineProperty(i.Sprite.prototype, "worldCenterX", {get: function() {
            return this.game.camera.x + this.center.x
        }}), Object.defineProperty(i.Sprite.prototype, "worldCenterY", {get: function() {
            return this.game.camera.y + this.center.y
        }}), Object.defineProperty(i.Sprite.prototype, "width", {get: function() {
        ...
        }}), Object.defineProperty(i.Sprite.prototype, "height", {get: function() {
        ...
        }}), Object.defineProperty(i.Sprite.prototype, "inputEnabled", {get: function() {
    ...
    }, i.TileSprite.prototype = i.Utils.extend(!0, e.TilingSprite.prototype, i.Sprite.prototype), i.TileSprite.prototype.constructor = i.TileSprite, Object.defineProperty(i.TileSprite.prototype, "angle", {get: function() {
            return i.Math.wrapAngle(i.Math.radToDeg(this.rotation))
        },set: function(t) {
            this.rotation = i.Math.degToRad(i.Math.wrapAngle(t))
        }}), Object.defineProperty(i.TileSprite.prototype, "frame", {get: function() {
            return this.animations.frame
        },set: function(t) {
            this.animations.frame = t
        }}), Object.defineProperty(i.TileSprite.prototype, "frameName", {get: function() {
            return this.animations.frameName
        },set: function(t) {
            this.animations.frameName = t
        }}), Object.defineProperty(i.TileSprite.prototype, "inCamera", {get: function() {
            return this._cache.cameraVisible
        }}), Object.defineProperty(i.TileSprite.prototype, "inputEnabled", {get: function() {
            return this.input.enabled
        },set: function(t) {
            t ? this.input.enabled === !1 && this.input.start() : this.input.enabled && this.input.stop()
        }}), i.Text = function(t, s, n, r, o) {
        s = s || 0, n = n || 0, r = r || "", o = o || "", this.game = t, this.exists = !0, this.alive = !0, this.group = null, this.name = "", this.type = i.TEXT, this._text = r, this._style = o, e.Text.call(this, r, o), this.position.x = this.x = s, this.position.y = this.y = n, this.anchor = new i.Point, this.scale = new i.Point(1, 1), this.fixedToCamera = !1, this.cameraOffset = new i.Point(s, n), this._cache = {dirty: !1,a00: 1,a01: 0,a02: s,a10: 0,a11: 1,a12: n,id: 1,x: -1,y: -1,scaleX: 1,scaleY: 1}, this._cache.x = this.x, this._cache.y = this.y, this.renderable = !0
    ...
    }, Object.defineProperty(i.Text.prototype, "angle", {get: function() {
            return i.Math.radToDeg(this.rotation)
        },set: function(t) {
            this.rotation = i.Math.degToRad(t)
        }}), Object.defineProperty(i.Text.prototype, "x", {get: function() {
            return this.position.x
        },set: function(t) {
            this.position.x = t
        }}), Object.defineProperty(i.Text.prototype, "y", {get: function() {
            return this.position.y
        },set: function(t) {
            this.position.y = t
        }}), Object.defineProperty(i.Text.prototype, "content", {get: function() {
            return this._text
        },set: function(t) {
            t !== this._text && (this._text = t, this.setText(t))
        }}), Object.defineProperty(i.Text.prototype, "font", {get: function() {
            return this._style
        },set: function(t) {
            t !== this._style && (this._style = t, this.setStyle(t))
        }}), i.BitmapText = function(t, s, n, r, o) {
        s = s || 0, n = n || 0, r = r || "", o = o || "", this.game = t, this.exists = !0, this.alive = !0, this.group = null, this.name = "", this.type = i.BITMAPTEXT, e.BitmapText.call(this, r, o), this.position.x = s, this.position.y = n, this.anchor = new i.Point, this.scale = new i.Point(1, 1), this._cache = {dirty: !1,a00: 1,a01: 0,a02: s,a10: 0,a11: 1,a12: n,id: 1,x: -1,y: -1,scaleX: 1,scaleY: 1}, this._cache.x = this.x, this._cache.y = this.y
    ...
    }, Object.defineProperty(i.BitmapText.prototype, "angle", {get: function() {
            return i.Math.radToDeg(this.rotation)
        },set: function(t) {
            this.rotation = i.Math.degToRad(t)
        }}), Object.defineProperty(i.BitmapText.prototype, "x", {get: function() {
            return this.position.x
        },set: function(t) {
            this.position.x = t
        }}), Object.defineProperty(i.BitmapText.prototype, "y", {get: function() {
            return this.position.y
        },set: function(t) {
            this.position.y = t
        ...
        for (var e = 1; e < t.points.length; e += 1)
            this.lineTo(t.points[e].x, t.points[e].y);
        this.lineTo(t.points[0].x, t.points[0].y)
    }, Object.defineProperty(i.Graphics.prototype, "angle", {get: function() {
            return i.Math.wrapAngle(i.Math.radToDeg(this.rotation))
        },set: function(t) {
            this.rotation = i.Math.degToRad(i.Math.wrapAngle(t))
        }}), Object.defineProperty(i.Graphics.prototype, "x", {get: function() {
            return this.position.x
        },set: function(t) {
            this.position.x = t
        }}), Object.defineProperty(i.Graphics.prototype, "y", {get: function() {
            return this.position.y
        },set: function(t) {
            this.position.y = t
        }}), i.RenderTexture = function(t, s, n, r) {
        this.game = t, this.name = s, e.EventTarget.call(this), this.width = n || 100, this.height = r || 100, this.indetityMatrix = e.mat3.create(), this.frame = new e.Rectangle(0, 0, this.width, this.height), this.type = i.RENDERTEXTURE, this._tempPoint = {x: 0,y: 0}, e.gl ? this.initWebGL() : this.initCanvas()
    ...
    }, i.Canvas = {create: function(t, e, i) {
            t = t || 256, e = e || 256;
            var s = document.createElement("canvas");
            return "string" == typeof i && (s.id = i), s.width = t, s.height = e, s.style.display = "block", s
        },getOffset: function(t, e) {
            e = e || new i.Point;
            var s = t.getBoundingClientRect(), n = t.clientTop || document.body.clientTop || 0, r = t.clientLeft || document.body.clientLeft || 0, o = 0, a = 0;
    ...
    }, i.StageScaleMode.EXACT_FIT = 0, i.StageScaleMode.NO_SCALE = 1, i.StageScaleMode.SHOW_ALL = 2, i.StageScaleMode.prototype = {startFullScreen: function(t) {
        ...
        }}, i.StageScaleMode.prototype.constructor = i.StageScaleMode, Object.defineProperty(i.StageScaleMode.prototype, "isFullScreen", {get: function() {
            return document.fullscreenElement || document.mozFullScreenElement || document.webkitFullscreenElement
        }}), Object.defineProperty(i.StageScaleMode.prototype, "isPortrait", {get: function() {
            return 0 === this.orientation || 180 == this.orientation
        }}), Object.defineProperty(i.StageScaleMode.prototype, "isLandscape", {get: function() {
        ...
        this.patchAndroidClearRectBug = !1, this.desktop = !1, this.iOS = !1, this.cocoonJS = !1, this.ejecta = !1, this.android = !1, this.chromeOS = !1, this.linux = !1, this.macOS = !1, this.windows = !1, this.canvas = !1, this.file = !1, this.fileSystem = !1, this.localStorage = !1, this.webGL = !1, this.worker = !1, this.touch = !1, this.mspointer = !1, this.css3D = !1, this.pointerLock = !1, this.typedArray = !1, this.vibration = !1, this.quirksMode = !1, this.arora = !1, this.chrome = !1, this.epiphany = !1, this.firefox = !1, this.ie = !1, this.ieVersion = 0, this.trident = !1, this.tridentVersion = 0, this.mobileSafari = !1, this.midori = !1, this.opera = !1, this.safari = !1, this.webApp = !1, this.silk = !1, this.audioData = !1, this.webAudio = !1, this.ogg = !1, this.opus = !1, this.mp3 = !1, this.wav = !1, this.m4a = !1, this.webm = !1, this.iPhone = !1, this.iPhone4 = !1, this.iPad = !1, this.pixelRatio = 0, this.littleEndian = !1, this._checkAudio(), this._checkBrowser(), this._checkCSS3D(), this._checkDevice(), this._checkFeatures(), this._checkOS()
    }, i.Device.prototype = {_checkOS: function() {
            ...
            var t = document.createElement("audio"), e = !1;
            try {
            ...
            var t, e = document.createElement("p"), i = {webkitTransform: "-webkit-transform",OTransform: "-o-transform",msTransform: "-ms-transform",MozTransform: "-moz-transform",transform: "transform"};
    ...
    }, i.RequestAnimationFrame.prototype = {start: function() {
            this.isRunning = !0;
            var t = this;
        ...
        "undefined" == typeof t && (t = []), this.c = 1, this.s0 = 0, this.s1 = 0, this.s2 = 0, this.sow(t)
    }, i.RandomDataGenerator.prototype = {rnd: function() {
            ...
            for (var e, i = 0; e = t[i++]; )
                this.s0 -= this.hash(e), this.s0 += ~~(this.s0 < 0), this.s1 -= this.hash(e), this.s1 += ~~(this.s1 < 0), this.s2 -= this.hash(e), this.s2 += ~~(this.s2 < 0)
        },hash: function(t) {
            var e, i, s;
            for (s = 4022871197, t = t.toString(), i = 0; i < t.length; i++)
                s += t.charCodeAt(i), e = .02519603282416938 * s, s = e >>> 0, e -= s, e *= s, s = e >>> 0, e -= s, s += 4294967296 * e;
        ...
        }}, i.RandomDataGenerator.prototype.constructor = i.RandomDataGenerator, i.Math = {PI2: 2 * Math.PI,fuzzyEqual: function(t, e, i) {
            ...
            for (var t = [], e = 0; e < arguments.length - 0; e++)
                t[e] = arguments[e + 0];
            ...
            if ("undefined" == typeof i && (i = !0), i && e.sort(), t < e[0])
                return e[0];
            for (var s = 1; e[s] < t; )
                s++;
            var n = e[s - 1], r = s < e.length ? e[s] : Number.POSITIVE_INFINITY;
            return t - n >= r - t ? r : n
            ...
            for (var t = 1, e = 0, i = arguments.length; i > t; t++)
                arguments[e] < arguments[t] && (e = t);
            return arguments[e]
        },min: function() {
            ...
            var r = .5 * (i - t), o = .5 * (s - e), a = n * n, h = n * a;
            ...
            if ("undefined" == typeof e && (e = 0), "undefined" == typeof i && (i = 0), null != t) {
                ...
                if ((0 === s || s > t.length - e) && (s = t.length - e), s > 0)
                    return t[e + Math.floor(Math.random() * s)]
            }
            return null
        },floor: function(t) {
            var e = 0 | t;
        ...
        this.maxObjects = n || 10, this.maxLevels = r || 4, this.level = o || 0, this.bounds = {x: Math.round(t),y: Math.round(e),width: i,height: s,subWidth: Math.floor(i / 2),subHeight: Math.floor(s / 2),right: Math.round(t) + Math.floor(i / 2),bottom: Math.round(e) + Math.floor(s / 2)}, this.objects = [], this.nodes = []
    }, i.QuadTree.prototype = {populate: function(t) {
            ...
            var e, i = 0;
            if (null != this.nodes[0] && (e = this.getIndex(t), -1 !== e))
            ...
            if (this.objects.push(t), this.objects.length > this.maxObjects && this.level < this.maxLevels)
                for (null == this.nodes[0] && this.split(); i < this.objects.length; )
                    e = this.getIndex(this.objects[i]), -1 !== e ? this.nodes[e].insert(this.objects.splice(i, 1)[0]) : i++
        },getIndex: function(t) {
            var e = -1;
            ...
            this.objects = [];
            for (var t = 0, e = this.nodes.length; e > t; t++)
                this.nodes[t] && (this.nodes[t].clear(), delete this.nodes[t])
    ...
    }, i.Circle.prototype = {circumference: function() {
        ...
        }}, i.Circle.prototype.constructor = i.Circle, Object.defineProperty(i.Circle.prototype, "diameter", {get: function() {
            return this._diameter
        },set: function(t) {
            t > 0 && (this._diameter = t, this._radius = .5 * t)
        }}), Object.defineProperty(i.Circle.prototype, "radius", {get: function() {
            return this._radius
        },set: function(t) {
            t > 0 && (this._radius = t, this._diameter = 2 * t)
        }}), Object.defineProperty(i.Circle.prototype, "left", {get: function() {
            return this.x - this._radius
        },set: function(t) {
            t > this.x ? (this._radius = 0, this._diameter = 0) : this.radius = this.x - t
        }}), Object.defineProperty(i.Circle.prototype, "right", {get: function() {
            return this.x + this._radius
        },set: function(t) {
            t < this.x ? (this._radius = 0, this._diameter = 0) : this.radius = t - this.x
        }}), Object.defineProperty(i.Circle.prototype, "top", {get: function() {
            return this.y - this._radius
        },set: function(t) {
            t > this.y ? (this._radius = 0, this._diameter = 0) : this.radius = this.y - t
        }}), Object.defineProperty(i.Circle.prototype, "bottom", {get: function() {
            return this.y + this._radius
        },set: function(t) {
            t < this.y ? (this._radius = 0, this._diameter = 0) : this.radius = t - this.y
        }}), Object.defineProperty(i.Circle.prototype, "area", {get: function() {
            return this._radius > 0 ? Math.PI * this._radius * this._radius : 0
        }}), Object.defineProperty(i.Circle.prototype, "empty", {get: function() {
            return 0 === this._diameter
        },set: function(t) {
            t === !0 && this.setTo(0, 0, 0)
        }}), i.Circle.contains = function(t, e, i) {
        if (e >= t.left && e <= t.right && i >= t.top && i <= t.bottom) {
            var s = (t.x - e) * (t.x - e), n = (t.y - i) * (t.y - i);
        ...
        var i = Math.abs(t.x - e.x - e.halfWidth), s = e.halfWidth + t.radius;
        if (i > s)
            return !1;
        var n = Math.abs(t.y - e.y - e.halfHeight), r = e.halfHeight + t.radius;
        if (n > r)
            return !1;
        if (i <= e.halfWidth || n <= e.halfHeight)
            return !0;
        var o = i - e.halfWidth, a = n - e.halfHeight, h = o * o, l = a * a, c = t.radius * t.radius;
        return c >= h + l
    }, i.Point = function(t, e) {
        t = t || 0, e = e || 0, this.x = t, this.y = e
    }, i.Point.prototype = {copyFrom: function(t) {
    ...
    }, i.Rectangle.prototype = {offset: function(t, e) {
            return this.x += t, this.y += e, this
        },offsetPoint: function(t) {
            return this.offset(t.x, t.y)
        ...
        }}, i.Rectangle.prototype.constructor = i.Rectangle, Object.defineProperty(i.Rectangle.prototype, "halfWidth", {get: function() {
            return Math.round(this.width / 2)
        }}), Object.defineProperty(i.Rectangle.prototype, "halfHeight", {get: function() {
            return Math.round(this.height / 2)
        }}), Object.defineProperty(i.Rectangle.prototype, "bottom", {get: function() {
            return this.y + this.height
        },set: function(t) {
            this.height = t <= this.y ? 0 : this.y - t
        }}), Object.defineProperty(i.Rectangle.prototype, "bottomRight", {get: function() {
            return new i.Point(this.right, this.bottom)
        },set: function(t) {
            this.right = t.x, this.bottom = t.y
        }}), Object.defineProperty(i.Rectangle.prototype, "left", {get: function() {
            return this.x
        },set: function(t) {
            this.width = t >= this.right ? 0 : this.right - t, this.x = t
        }}), Object.defineProperty(i.Rectangle.prototype, "right", {get: function() {
            return this.x + this.width
        },set: function(t) {
            this.width = t <= this.x ? 0 : this.x + t
        }}), Object.defineProperty(i.Rectangle.prototype, "volume", {get: function() {
            return this.width * this.height
        }}), Object.defineProperty(i.Rectangle.prototype, "perimeter", {get: function() {
            return 2 * this.width + 2 * this.height
        }}), Object.defineProperty(i.Rectangle.prototype, "centerX", {get: function() {
            return this.x + this.halfWidth
        },set: function(t) {
            this.x = t - this.halfWidth
        }}), Object.defineProperty(i.Rectangle.prototype, "centerY", {get: function() {
            return this.y + this.halfHeight
        },set: function(t) {
            this.y = t - this.halfHeight
        }}), Object.defineProperty(i.Rectangle.prototype, "top", {get: function() {
            return this.y
        },set: function(t) {
            t >= this.bottom ? (this.height = 0, this.y = t) : this.height = this.bottom - t
        }}), Object.defineProperty(i.Rectangle.prototype, "topLeft", {get: function() {
            return new i.Point(this.x, this.y)
        },set: function(t) {
            this.x = t.x, this.y = t.y
        }}), Object.defineProperty(i.Rectangle.prototype, "empty", {get: function() {
            return !this.width || !this.height
        },set: function(t) {
        ...
        this.game = t
    }, i.Net.prototype = {getHostName: function() {
        ...
        this.game = t, this._tweens = [], this._add = [], this.game.onPause.add(this.pauseAll, this), this.game.onResume.add(this.resumeAll, this)
    }, i.TweenManager.prototype = {getAll: function() {
            return this._tweens
        },removeAll: function() {
            ...
            if (0 === this._tweens.length && 0 === this._add.length)
                return !1;
            for (var t = 0, e = this._tweens.length; e > t; )
                this._tweens[t].update(this.game.time.now) ? t++ : (this._tweens.splice(t, 1), e--);
        ...
        this.onStart = new i.Signal, this.onLoop = new i.Signal, this.onComplete = new i.Signal, this.isRunning = !1
            ...
            if (null !== this._onUpdateCallback && this._onUpdateCallback.call(this._onUpdateCallbackContext, this, s), 1 == i) {
                ...
                for (var a = 0, h = this._chainedTweens.length; h > a; a++)
                    this._chainedTweens[a].start(t);
                return !1
            }
            return !0
        }}, i.Tween.prototype.constructor = i.Tween, i.Easing = {Linear: {None: function(t) {
                return t
    ...
    }, i.Time.prototype = {boot: function() {
            this.events.start()
        },create: function(t) {
        ...
        "undefined" == typeof e && (e = !0), this.game = t, this.running = !1, this.autoDestroy = e, this.expired = !1, this.events = [], this.onComplete = new i.Signal, this.nextTick = 0, this.paused = !1, this._started = 0, this._pauseStarted = 0, this._now = 0, this._len = 0, this._i = 0
    }, i.Timer.MINUTE = 6e4, i.Timer.SECOND = 1e3, i.Timer.HALF = 500, i.Timer.QUARTER = 250, i.Timer.prototype = {create: function(t, e, s, n, r, o) {
            var a = t;
            ...
            for (var e = 0; e < this.events.length; e++)
                if (this.events[e] === t)
                    return this.events.splice(e, 1), !0;
            return !1
        },order: function() {
            ...
            for (var t = this.game.time.now - this._pauseStarted, e = 0; e < this.events.length; e++)
                this.events[e].tick += t;
            this.nextTick += t, this.paused = !1
        },destroy: function() {
            this.onComplete.removeAll(), this.running = !1, this.events = []
        }}, Object.defineProperty(i.Timer.prototype, "next", {get: function() {
            return this.nextTick
        }}), Object.defineProperty(i.Timer.prototype, "duration", {get: function() {
            return this.running && this.nextTick > this._now ? this.nextTick - this._now : 0
        }}), Object.defineProperty(i.Timer.prototype, "length", {get: function() {
            return this.events.length
        }}), Object.defineProperty(i.Timer.prototype, "ms", {get: function() {
            return this._now
        }}), Object.defineProperty(i.Timer.prototype, "seconds", {get: function() {
        ...
        this.sprite = t, this.game = t.game, this.currentFrame = null, this.updateIfVisible = !0, this.isLoaded = !1, this._frameData = null, this._anims = {}, this._outputFrames = []
    }, i.AnimationManager.prototype = {loadFrameData: function(t) {
            ...
            if (this._anims[t]) {
                if (this.currentAnim != this._anims[t])
                    return this.currentAnim = this._anims[t], this.currentAnim.paused = !1, this.currentAnim.play(e, i, s);
                if (this.currentAnim.isPlaying === !1)
                    return this.currentAnim.paused = !1, this.currentAnim.play(e, i, s)
            }
        },stop: function(t, e) {
        ...
        }}, i.AnimationManager.prototype.constructor = i.AnimationManager, Object.defineProperty(i.AnimationManager.prototype, "frameData", {get: function() {
            return this._frameData
        }}), Object.defineProperty(i.AnimationManager.prototype, "frameTotal", {get: function() {
            return this._frameData ? this._frameData.total : -1
        }}), Object.defineProperty(i.AnimationManager.prototype, "paused", {get: function() {
            return this.currentAnim.isPaused
        },set: function(t) {
            this.currentAnim.paused = t
        }}), Object.defineProperty(i.AnimationManager.prototype, "frame", {get: function() {
        ...
        }}), Object.defineProperty(i.AnimationManager.prototype, "frameName", {get: function() {
    ...
    }, i.Animation.prototype = {play: function(t, i, s) {
        ...
        }}, i.Animation.prototype.constructor = i.Animation, Object.defineProperty(i.Animation.prototype, "paused", {get: function() {
            return this.isPaused
        },set: function(t) {
        ...
        }}), Object.defineProperty(i.Animation.prototype, "frameTotal", {get: function() {
            return this._frames.length
        }}), Object.defineProperty(i.Animation.prototype, "frame", {get: function() {
        ...
        if (s > e)
            for (var h = e; s >= h; h++)
                a = "number" == typeof r ? i.Utils.pad(h.toString(), r, "0", 1) : h.toString(), a = t + a + n, o.push(a);
        else
            for (var h = e; h >= s; h--)
                a = "number" == typeof r ? i.Utils.pad(h.toString(), r, "0", 1) : h.toString(), a = t + a + n, o.push(a);
        return o
    ...
    }, i.Frame.prototype = {setTrim: function(t, e, i, s, n, r, o) {
        ...
        this._frames = [], this._frameNames = []
    }, i.FrameData.prototype = {addFrame: function(t) {
            ...
            if ("undefined" == typeof e && (e = !0), "undefined" == typeof i && (i = []), "undefined" == typeof t || 0 === t.length)
                ...
                for (var s = 0, n = t.length; n > s; s++)
                    i.push(e ? this.getFrame(t[s]) : this.getFrameByName(t[s]));
            return i
        },getFrameIndexes: function(t, e, i) {
            if ("undefined" == typeof e && (e = !0), "undefined" == typeof i && (i = []), "undefined" == typeof t || 0 === t.length)
                for (var s = 0, n = this._frames.length; n > s; s++)
                    i.push(this._frames[s].index);
            else
                for (var s = 0, n = t.length; n > s; s++)
                    e ? i.push(t[s]) : this.getFrameByName(t[s]) && i.push(this.getFrameByName(t[s]).index);
            return i
        }}, i.FrameData.prototype.constructor = i.FrameData, Object.defineProperty(i.FrameData.prototype, "total", {get: function() {
            return this._frames.length
        }}), i.AnimationParser = {spriteSheet: function(t, s, n, r, o, a, h) {
            var l = t.cache.getImage(s);
            if (null == l)
                return null;
            var c = l.width, u = l.height;
            0 >= n && (n = Math.floor(-c / Math.min(-1, n))), 0 >= r && (r = Math.floor(-u / Math.min(-1, r)));
            var d = Math.round(c / n), p = Math.round(u / r), f = d * p;
            if (-1 !== o && (f = o), 0 === c || 0 === u || n > c || r > u || 0 === f)
            ...
            if (!s.frames)
                return console.warn("Phaser.AnimationParser.JSONData: Invalid Texture Atlas JSON given, missing 'frames' array"), void console.log(s);
            for (var r, o = new i.FrameData, a = s.frames, h = 0; h < a.length; h++) {
                var l = t.rnd.uuid();
                r = o.addFrame(new i.Frame(h, a[h].frame.x, a[h].frame.y, a[h].frame.w, a[h].frame.h, a[h].filename, l)), e.TextureCache[l] = new e.Texture(e.BaseTextureCache[n], {x: a[h].frame.x,y: a[h].frame.y,width: a[h].frame.w,height: a[h].frame.h}), a[h].trimmed && (r.setTrim(a[h].trimmed, a[h].sourceSize.w, a[h].sourceSize.h, a[h].spriteSourceSize.x, a[h].spriteSourceSize.y, a[h].spriteSourceSize.w, a[h].spriteSourceSize.h), e.TextureCache[l].trimmed = !0, e.TextureCache[l].trim.x = a[h].spriteSourceSize.x, e.TextureCache[l].trim.y = a[h].spriteSourceSize.y)
            }
            return o
        },JSONDataHash: function(t, s, n) {
            if (!s.frames)
                return console.warn("Phaser.AnimationParser.JSONDataHash: Invalid Texture Atlas JSON given, missing 'frames' object"), void console.log(s);
            var r, o = new i.FrameData, a = s.frames, h = 0;
            for (var l in a) {
                var c = t.rnd.uuid();
                r = o.addFrame(new i.Frame(h, a[l].frame.x, a[l].frame.y, a[l].frame.w, a[l].frame.h, l, c)), e.TextureCache[c] = new e.Texture(e.BaseTextureCache[n], {x: a[l].frame.x,y: a[l].frame.y,width: a[l].frame.w,height: a[l].frame.h}), a[l].trimmed && (r.setTrim(a[l].trimmed, a[l].sourceSize.w, a[l].sourceSize.h, a[l].spriteSourceSize.x, a[l].spriteSourceSize.y, a[l].spriteSourceSize.w, a[l].spriteSourceSize.h), e.TextureCache[c].trimmed = !0, e.TextureCache[c].trim.x = a[l].spriteSourceSize.x, e.TextureCache[c].trim.y = a[l].spriteSourceSize.y), h++
            }
            return o
        },XMLData: function(t, s, n) {
            if (!s.getElementsByTagName("TextureAtlas"))
        ...
        this.game = t, this._canvases = {}, this._images = {}, this._textures = {}, this._sounds = {}, this._text = {}, this._tilemaps = {}, this._binary = {}, this._bitmapDatas = {}, this.addDefaultImage(), this.addMissingImage(), this.onSoundUnlock = new i.Signal
    }, i.Cache.prototype = {addCanvas: function(t, e, i) {
            ...
            this._images[t] = {url: s,data: n,spriteSheet: !0,frameWidth: r,frameHeight: o,margin: h,spacing: l}, e.BaseTextureCache[t] = new e.BaseTexture(n), e.TextureCache[t] = new e.Texture(e.BaseTextureCache[t]), this._images[t].frameData = i.AnimationParser.spriteSheet(this.game, t, r, o, a, h, l)
            ...
            this._images[t] = {url: s,data: n,spriteSheet: !1}, this._images[t].frame = new i.Frame(0, 0, 0, n.width, n.height, t, this.game.rnd.uuid()), e.BaseTextureCache[t] = new e.BaseTexture(n), e.TextureCache[t] = new e.Texture(e.BaseTextureCache[t])
            ...
            for (var t in this._canvases)
                delete this._canvases[t.key];
            for (var t in this._images)
                delete this._images[t.key];
            for (var t in this._sounds)
                delete this._sounds[t.key];
            for (var t in this._text)
                delete this._text[t.key]
        ...
        this.game = t, this._fileList = [], this._fileIndex = 0, this._progressChunk = 0, this._xhr = new XMLHttpRequest, this.isLoading = !1, this.hasLoaded = !1, this.progress = 0, this.progressFloat = 0, this.preloadSprite = null, this.crossOrigin = "", this.baseURL = "", this.onFileComplete = new i.Signal, this.onFileError = new i.Signal, this.onLoadStart = new i.Signal, this.onLoadComplete = new i.Signal
    }, i.Loader.TEXTURE_ATLAS_JSON_ARRAY = 0, i.Loader.TEXTURE_ATLAS_JSON_HASH = 1, i.Loader.TEXTURE_ATLAS_XML_STARLING = 2, i.Loader.prototype = {setPreloadSprite: function(t, e) {
            e = e || 0, this.preloadSprite = {sprite: t,direction: e,width: t.width,height: t.height,crop: null}, this.preloadSprite.crop = 0 === e ? new i.Rectangle(0, 0, 1, t.height) : new i.Rectangle(0, 0, t.width, 1), t.crop = this.preloadSprite.crop, t.cropEnabled = !0
        },checkKeyExists: function(t, e) {
            if (this._fileList.length > 0)
                for (var i = 0; i < this._fileList.length; i++)
                    if (this._fileList[i].type === t && this._fileList[i].key === e)
                        return !0;
            return !1
            ...
            return "undefined" == typeof n && (n = -1), "undefined" == typeof r && (r = 0), "undefined" == typeof o && (o = 0), this.addToFileList("spritesheet", t, e, {frameWidth: i,frameHeight: s,frameMax: n,margin: r,spacing: o}), this
            ...
            if (s) {
                ...
                this.addToFileList("tilemap", t, e, {format: n});
            return this
        },bitmapFont: function(t, e, i, s) {
            if ("undefined" == typeof i && (i = null), "undefined" == typeof s && (s = null), i)
                this.addToFileList("bitmapfont", t, e, {xmlURL: i});
                ...
                try {
                    if (window.DOMParser) {
                        ...
                        n = new ActiveXObject("Microsoft.XMLDOM"), n.async = "false", n.loadXML(s)
                } catch (o) {
                    n = void 0
                }
            ...
            if ("undefined" == typeof s && (s = null), "undefined" == typeof n && (n = null), "undefined" == typeof r && (r = i.Loader.TEXTURE_ATLAS_JSON_ARRAY), s)
                this.addToFileList("textureatlas", t, e, {atlasURL: s,format: r});
            else {
                switch (r) {
                        ...
                        if ("string" == typeof n) {
                            ...
                            try {
                                if (window.DOMParser) {
                                    ...
                                    o = new ActiveXObject("Microsoft.XMLDOM"), o.async = "false", o.loadXML(n)
                            } catch (h) {
                                o = void 0
                            }
            ...
            var t = this._fileList[this._fileIndex], e = this;
            switch (t.type) {
                case "image":
                case "spritesheet":
                case "textureatlas":
                ...
                case "tilemap":
                    if (this._xhr.open("GET", this.baseURL + t.url, !0), this._xhr.responseType = "text", t.format === i.Tilemap.TILED_JSON)
                        ...
                        if (t.format !== i.Tilemap.CSV)
                            throw new Error("Phaser.Loader. Invalid Tilemap format: " + t.format);
                        this._xhr.onload = function() {
            ...
            "string" == typeof t && (t = [t]);
            for (var i = 0; i < t.length; i++)
                if (e = t[i].toLowerCase(), e = e.substr((Math.max(0, e.lastIndexOf(".")) || 1 / 0) + 1), this.game.device.canPlayAudio(e))
                    return t[i];
            return null
            ...
            if (!this._fileList[t])
                return void console.warn("Phaser.Loader fileComplete invalid index " + t);
            ...
            switch (e.type) {
                ...
                case "textureatlas":
                    if (null == e.atlasURL)
                        this.game.cache.addTextureAtlas(e.key, e.url, e.data, e.atlasData, e.format);
                    else {
                        if (s = !1, this._xhr.open("GET", this.baseURL + e.atlasURL, !0), this._xhr.responseType = "text", e.format == i.Loader.TEXTURE_ATLAS_JSON_ARRAY || e.format == i.Loader.TEXTURE_ATLAS_JSON_HASH)
                            ...
                            if (e.format != i.Loader.TEXTURE_ATLAS_XML_STARLING)
                ...
                case "audio":
                    if (this.game.sound.usingWebAudio) {
                        ...
                        e.data.removeEventListener("canplaythrough", i.GAMES[this.game.id].load.fileComplete), this.game.cache.addSound(e.key, e.url, e.data, !1, !0);
                    break;
                case "text":
            ...
            if (!this._fileList[t])
                return void console.warn("Phaser.Loader jsonLoadComplete invalid index " + t);
            var e = this._fileList[t], i = JSON.parse(this._xhr.responseText);
            ...
            if (!this._fileList[t])
                return void console.warn("Phaser.Loader csvLoadComplete invalid index " + t);
            var e = this._fileList[t], i = this._xhr.responseText;
            ...
            try {
                if (window.DOMParser) {
                    ...
                    e = new ActiveXObject("Microsoft.XMLDOM"), e.async = "false", e.loadXML(i)
            } catch (n) {
                e = void 0
            }
            ...
            for (var t = 0, e = 0; e < this._fileList.length; e++)
                this._fileList[e].loaded && t++;
            return t
        },totalQueuedFiles: function() {
            for (var t = 0, e = 0; e < this._fileList.length; e++)
                this._fileList[e].loaded === !1 && t++;
            return t
        }}, i.Loader.prototype.constructor = i.Loader, i.LoaderParser = {bitmapFont: function(t, i, s) {
            if (!i.getElementsByTagName("font"))
                return void console.warn("Phaser.LoaderParser.bitmapFont: Invalid XML given, missing <font> tag");
            var n = e.TextureCache[s], r = {}, o = i.getElementsByTagName("info")[0], a = i.getElementsByTagName("common")[0];
            ...
            for (var h = i.getElementsByTagName("char"), l = 0; l < h.length; l++) {
                var c = parseInt(h[l].attributes.getNamedItem("id").nodeValue, 10), u = {x: parseInt(h[l].attributes.getNamedItem("x").nodeValue, 10),y: parseInt(h[l].attributes.getNamedItem("y").nodeValue, 10),width: parseInt(h[l].attributes.getNamedItem("width").nodeValue, 10),height: parseInt(h[l].attributes.getNamedItem("height").nodeValue, 10)};
                e.TextureCache[c] = new e.Texture(n, u), r.chars[c] = {xOffset: parseInt(h[l].attributes.getNamedItem("xoffset").nodeValue, 10),yOffset: parseInt(h[l].attributes.getNamedItem("yoffset").nodeValue, 10),xAdvance: parseInt(h[l].attributes.getNamedItem("xadvance").nodeValue, 10),kerning: {},texture: new e.Texture(n, u)}
            }
            var d = i.getElementsByTagName("kerning");
            for (l = 0; l < d.length; l++) {
                var p = parseInt(d[l].attributes.getNamedItem("first").nodeValue, 10), f = parseInt(d[l].attributes.getNamedItem("second").nodeValue, 10), g = parseInt(d[l].attributes.getNamedItem("amount").nodeValue, 10);
        ...
        "undefined" == typeof s && (s = 1), "undefined" == typeof n && (n = !1), "undefined" == typeof r && (r = t.sound.connectToMaster), this.game = t, this.name = e, this.key = e, this.loop = n, this._volume = s, this.markers = {}, this.context = null, this._buffer = null, this._muted = !1, this.autoplay = !1, this.totalDuration = 0, this.startTime = 0, this.currentTime = 0, this.duration = 0, this.stopTime = 0, this.paused = !1, this.pausedPosition = 0, this.pausedTime = 0, this.isPlaying = !1, this.currentMarker = "", this.pendingPlayback = !1, this.override = !1, this.usingWebAudio = this.game.sound.usingWebAudio, this.usingAudioTag = this.game.sound.usingAudioTag, this.externalNode = null, this.usingWebAudio ? (this.context = this.game.sound.context, this.masterGainNode = this.game.sound.masterGain, this.gainNode = "undefined" == typeof this.context.createGain ? this.context.createGainNode() : this.context.createGain(), this.gainNode.gain.value = s * this.game.sound.volume, r && this.gainNode.connect(this.masterGainNode)) : this.game.cache.getSound(e) && this.game.cache.isSoundReady(e) ? (this._sound = this.game.cache.getSoundData(e), this.totalDuration = 0, this._sound.duration && (this.totalDuration = this._sound.duration)) : this.game.cache.onSoundUnlock.add(this.soundHasUnlocked, this), this.onDecoded = new i.Signal, this.onPlay = new i.Signal, this.onPause = new i.Signal, this.onResume = new i.Signal, this.onLoop = new i.Signal, this.onStop = new i.Signal, this.onMute = new i.Signal, this.onMarkerComplete = new i.Signal
    }, i.Sound.prototype = {soundHasUnlocked: function(t) {
            ...
            if (t = t || "", e = e || 0, "undefined" == typeof i && (i = this._volume), "undefined" == typeof s && (s = !1), "undefined" == typeof n && (n = !0), this.isPlaying !== !0 || n !== !1 || this.override !== !1) {
                if (this.isPlaying && this.override && (this.usingWebAudio ? "undefined" == typeof this._sound.stop ? this._sound.noteOff(0) : this._sound.stop(0) : this.usingAudioTag && (this._sound.pause(), this._sound.currentTime = 0)), this.currentMarker = t, "" !== t) {
                    if (!this.markers[t])
                        return void console.warn("Phaser.Sound.play: audio marker " + t + " doesn't exist");
                    ...
                    this.position = e, this.volume = i, this.loop = s, this.duration = 0, this.durationMS = 0, this._tempMarker = t, this._tempPosition = e, this._tempVolume = i, this._tempLoop = s;
        ...
        }}, i.Sound.prototype.constructor = i.Sound, Object.defineProperty(i.Sound.prototype, "isDecoding", {get: function() {
            return this.game.cache.getSound(this.key).isDecoding
        }}), Object.defineProperty(i.Sound.prototype, "isDecoded", {get: function() {
            return this.game.cache.isSoundDecoded(this.key)
        }}), Object.defineProperty(i.Sound.prototype, "mute", {get: function() {
            return this._muted
        },set: function(t) {
        ...
        }}), Object.defineProperty(i.Sound.prototype, "volume", {get: function() {
            return this._volume
        },set: function(t) {
        ...
        this.game = t, this.onSoundDecode = new i.Signal, this._muted = !1, this._unlockSource = null, this._volume = 1, this._sounds = [], this.context = null, this.usingWebAudio = !0, this.usingAudioTag = !1, this.noAudio = !1, this.connectToMaster = !0, this.touchLocked = !1, this.channels = 32
    }, i.SoundManager.prototype = {boot: function() {
            ...
            return n.play(), n
        }}, i.SoundManager.prototype.constructor = i.SoundManager, Object.defineProperty(i.SoundManager.prototype, "mute", {get: function() {
            return this._muted
        },set: function(t) {
            if (t = t || null) {
                if (this._muted)
        ...
        }}), Object.defineProperty(i.SoundManager.prototype, "volume", {get: function() {
        ...
        this.game = t, this.context = t.context, this.font = "14px Courier", this.columnWidth = 100, this.lineHeight = 16, this.renderShadow = !0, this.currentX = 0, this.currentY = 0, this.currentAlpha = 1
    }, i.Utils.Debug.prototype = {start: function(t, e, i, s) {
            ...
            if (null != this.context) {
                for (var t = this.currentX, e = 0; e < arguments.length; e++)
                    this.renderShadow && (this.context.fillStyle = "rgb(0,0,0)", this.context.fillText(arguments[e], t + 1, this.currentY + 1), this.context.fillStyle = this.currentColor), this.context.fillText(arguments[e], t, this.currentY), t += this.columnWidth;
            ...
            if (null !== this.context || null !== s) {
                e = e || "rgb(255,255,255)";
                var n = t.x - this.game.camera.x, r = t.y - this.game.camera.y;
                if (t.type === i.Physics.Arcade.CIRCLE)
                    ...
                    for (var a = 1; a < o.length; a++)
                        this.context.lineTo(n + o[a].x, r + o[a].y);
                    ...
                    for (var a = 1; a < o.length; a++)
                        this.context.fillStyle = "rgb(255," + 40 * a + ",0)", this.context.fillRect(n + o[a].x - 2, r + o[a].y - 2, 5, 5);
                    this.stop()
                }
            }
            ...
            var i = parseInt(e.substring(0, 2), 16), s = parseInt(e.substring(2, 4), 16), n = parseInt(e.substring(4, 6), 16);
            return i << 16 | s << 8 | n
        },getColorInfo: function(t) {
            var e = i.Color.getRGB(t), s = i.Color.RGBtoHSV(t), n = i.Color.RGBtoHexstring(t) + "\n";
            ...
            var e = "0123456789ABCDEF", i = t % 16, s = (t - i) / 16, n = e.charAt(s) + e.charAt(i);
            return n
        },interpolateColor: function(t, e, s, n, r) {
            "undefined" == typeof r && (r = 255);
            var o = i.Color.getRGB(t), a = i.Color.getRGB(e), h = (a.red - o.red) * n / s + o.red, l = (a.green - o.green) * n / s + o.green, c = (a.blue - o.blue) * n / s + o.blue;
            return i.Color.getColor32(r, h, l, c)
        },interpolateColorWithRGB: function(t, e, s, n, r, o) {
            var a = i.Color.getRGB(t), h = (e - a.red) * o / r + a.red, l = (s - a.green) * o / r + a.green, c = (n - a.blue) * o / r + a.blue;
            return i.Color.getColor(h, l, c)
        },interpolateRGB: function(t, e, s, n, r, o, a, h) {
            var l = (n - t) * h / a + t, c = (r - e) * h / a + e, u = (o - s) * h / a + s;
            return i.Color.getColor(l, c, u)
        },getRandomColor: function(t, e, s) {
            if ("undefined" == typeof t && (t = 0), "undefined" == typeof e && (e = 255), "undefined" == typeof s && (s = 255), e > 255)
                return i.Color.getColor(255, 255, 255);
            if (t > e)
                return i.Color.getColor(255, 255, 255);
            var n = t + Math.round(Math.random() * (e - t)), r = t + Math.round(Math.random() * (e - t)), o = t + Math.round(Math.random() * (e - t));
            return i.Color.getColor32(s, n, r, o)
        },getRGB: function(t) {
            return {alpha: t >>> 24,red: t >> 16 & 255,green: t >> 8 & 255,blue: 255 & t}
        },getWebRGB: function(t) {
            var e = (t >>> 24) / 255, i = t >> 16 & 255, s = t >> 8 & 255, n = 255 & t;
        ...
        function o(t, e, i, s, n, o) {
            var a = g.pop(), h = g.pop(), l = p.pop().copy(e).sub(t), c = l.dot(n);
            if (r(i, n, a), r(s, n, h), h[0] += c, h[1] += c, a[0] > h[1] || h[0] > a[1])
                return p.push(l), g.push(a), g.push(h), !0;
            if (o) {
                var u = 0;
                if (a[0] < h[0])
                    if (o.aInB = !1, a[1] < h[1])
                        ...
                        var d = a[1] - h[0], f = h[1] - a[0];
                        u = f > d ? d : -f
                    }
                else if (o.bInA = !1, a[1] > h[1])
                    u = a[0] - h[1], o.aInB = !1;
                else {
                    var d = a[1] - h[0], f = h[1] - a[0];
                    u = f > d ? d : -f
        ...
        function a(t, e) {
            var i = t.len2(), s = e.dot(t);
            return 0 > s ? m : s > i ? _ : y
        }
        function h(t, e, i) {
            var s = p.pop().copy(e.pos).sub(t.pos), n = t.r + e.r, r = n * n, o = s.len2();
            if (o > r)
                return p.push(s), !1;
            if (i) {
                var a = Math.sqrt(o);
        ...
        function l(t, e, i) {
            for (var s = p.pop().copy(e.pos).sub(t.pos), n = e.r, r = n * n, o = t.points, h = o.length, l = p.pop(), c = p.pop(), u = 0; h > u; u++) {
                var d = u === h - 1 ? 0 : u + 1, f = 0 === u ? h - 1 : u - 1, g = 0, y = null;
                ...
                if (x === m) {
                    ...
                    if (x = a(l, v), x === _) {
                        var b = c.len();
                        if (b > n)
                            return p.push(s), p.push(l), p.push(c), p.push(v), !1;
                    ...
                    if (l.copy(t.edges[d]), c.copy(s).sub(o[d]), x = a(l, c), x === m) {
                        var b = c.len();
                        if (b > n)
                            return p.push(s), p.push(l), p.push(c), !1;
                        i && (i.bInA = !1, y = c.normalize(), g = n - b)
                    }
                } else {
                    var w = l.perp().normalize(), b = c.dot(w), T = Math.abs(b);
                    if (b > 0 && T > n)
                        return p.push(s), p.push(w), p.push(c), !1;
        ...
        function u(t, e, i) {
            for (var s = t.points, n = s.length, r = e.points, a = r.length, h = 0; n > h; h++)
                if (o(t.pos, e.pos, s, r, t.normals[h], i))
                    return !1;
            for (var h = 0; a > h; h++)
                if (o(t.pos, e.pos, s, r, e.normals[h], i))
                    return !1;
        ...
        d.Vector = t, d.V = t, t.prototype.copy = t.prototype.copy = function(t) {
            ...
            for (var e = this.points, i = e.length, s = 0; i > s; s++) {
                var n = e[s], r = i - 1 > s ? e[s + 1] : e[0], o = (new t).copy(r).sub(n), a = (new t).copy(o).perp().normalize();
                this.edges.push(o), this.normals.push(a)
            }
            return this
        }, i.prototype.rotate = i.prototype.rotate = function(t) {
            var e, i = this.points, s = this.edges, n = this.normals, r = i.length, o = Math.cos(t), a = Math.sin(t);
            for (e = 0; r > e; e++)
                i[e].rotatePrecalc(a, o), s[e].rotatePrecalc(a, o), n[e].rotatePrecalc(a, o);
            return this
        }, i.prototype.scale = i.prototype.scale = function(t, e) {
            var i, s = this.points, n = this.edges, r = this.normals, o = s.length;
            for (i = 0; o > i; i++)
                s[i].scale(t, e), n[i].scale(t, e), r[i].scale(t, e);
            return this
        }, i.prototype.translate = i.prototype.translate = function(t, e) {
            var i, s = this.points, n = s.length;
            for (i = 0; n > i; i++)
                s[i].x += t, s[i].y += e;
            return this
        }, d.Box = s, s.prototype.toPolygon = s.prototype.toPolygon = function() {
            var e = this.pos, s = this.w, n = this.h;
        ...
        this.game = t, this.gravity = new i.Point, this.worldLeft = null, this.worldRight = null, this.worldTop = null, this.worldBottom = null, this.worldPolys = [null, null, null, null], this.quadTree = new i.QuadTree(this.game.world.bounds.x, this.game.world.bounds.y, this.game.world.bounds.width, this.game.world.bounds.height, this.maxObjects, this.maxLevels), this.maxObjects = 10, this.maxLevels = 4, this._mapData = [], this._mapTiles = 0, this._result = !1, this._total = 0, this._angle = 0, this._drag = 0, this._dx = 0, this._dy = 0, this._p = new i.Point(0, 0), this._intersection = [0, 0, 0, 0], this._gravityX = 0, this._gravityY = 0, this._response = new SAT.Response, this.setBoundsToWorld(!0, !0, !0, !0)
    }, i.Physics.Arcade.RECT = 0, i.Physics.Arcade.CIRCLE = 1, i.Physics.Arcade.POLYGON = 2, i.Physics.Arcade.prototype = {checkBounds: function(t) {
            if (!t.collideWorldBounds || !this.worldLeft && !this.worldRight && !this.worldTop && !this.worldBottom)
                return !1;
            this._response.clear();
            var e = SAT.testPolygonPolygon, s = t.polygon, n = !1;
            ...
            if (0 !== e.length) {
                ...
                for (var a = 0, h = this._potentials.length; h > a; a++)
                    this.separate(t.body, this._potentials[a], n, r, o) && (s && s.call(r, t, this._potentials[a].sprite), this._total++)
            }
        },collideGroupVsSelf: function(t, e, i, s, n) {
            if (0 !== t.length)
                for (var r = t._container.children.length, o = 0; r > o; o++)
                    for (var a = o + 1; r >= a; a++)
                        t._container.children[o] && t._container.children[a] && t._container.children[o].exists && t._container.children[a].exists && this.collideSpriteVsSprite(t._container.children[o], t._container.children[a], e, i, s, n)
            ...
            if (0 !== t.length && 0 !== e.length && t._container.first._iNext) {
                ...
                do
                    o.exists && this.collideSpriteVsGroup(o, e, i, s, n, r), o = o._iNext;
            ...
            if (this._mapData = e.getTiles(t.body.left, t.body.top, t.body.width, t.body.height, !0), 0 !== this._mapData.length)
                if (this._mapData.length > 1)
                    this.separateTiles(t.body, this._mapData);
                else {
                    var r = 0;
            ...
            if (0 !== t.length && t._container.first._iNext) {
                ...
                do
                    r.exists && this.collideSpriteVsTilemapLayer(r, e, i, s, n), r = r._iNext;
            ...
            for (var i, s = !1, n = 0; n < e.length; n++)
                i = e[n], this.separateTile(t, i) && (s = !0);
            return s
        },separateTile: function(t, e) {
            if (this._intersection = this.tileIntersects(t, e), 0 === this._intersection[4] || 0 === this._intersection[2] || 0 === this._intersection[3])
                return !1;
            if (e.tile.callback || e.layer.callbacks[e.tile.index]) {
                if (e.tile.callback && e.tile.callback.call(e.tile.callbackContext, t.sprite, e) === !1)
                    return !1;
                if (e.layer.callbacks[e.tile.index] && e.layer.callbacks[e.tile.index].callback.call(e.layer.callbacks[e.tile.index].callbackContext, t.sprite, e) === !1)
                    return !1
            }
        ...
        this.sprite = t, this.game = t.game, this.offset = new i.Point, this.preX = t.world.x, this.preY = t.world.y, this.preRotation = t.angle, this.velocity = new i.Point, this.acceleration = new i.Point, this.speed = 0, this.angle = 0, this.gravity = new i.Point, this.bounce = new i.Point, this.minVelocity = new i.Point, this.maxVelocity = new i.Point(1e3, 1e3), this.angularVelocity = 0, this.angularAcceleration = 0, this.angularDrag = 0, this.maxAngular = 1e3, this.mass = 1, this.linearDamping = 0, this.checkCollision = {none: !1,any: !0,up: !0,down: !0,left: !0,right: !0}, this.touching = {none: !0,up: !1,down: !1,left: !1,right: !1}, this.blocked = {x: 0,y: 0,up: !1,down: !1,left: !1,right: !1}, this.facing = i.NONE, this.rebound = !0, this.immovable = !1, this.moves = !0, this.rotation = 0, this.allowRotation = !0, this.allowGravity = !0, this.customSeparateCallback = null, this.customSeparateContext = null, this.collideCallback = null, this.collideCallbackContext = null, this.collideWorldBounds = !1, this.type = i.Physics.Arcade.RECT, this.shape = null, this.polygon = null, this.left = 0, this.right = 0, this.top = 0, this.bottom = 0, this.width = 0, this.height = 0, this.contacts = [], this.overlapX = 0, this.overlapY = 0, this._temp = null, this._dx = 0, this._dy = 0, this._sx = t.scale.x, this._sy = t.scale.y, this._distances = [0, 0, 0, 0], this._vx = 0, this._vy = 0, this.setRectangle(t.width, t.height, 0, 0), this.sprite.events.onBeginContact = new i.Signal, this.sprite.events.onEndContact = new i.Signal
    }, i.Physics.Arcade.Body.prototype = {updateScale: function() {
            ...
            if (this.mass === t.mass && this.speed > 0 && t.speed > 0)
                this._dx = t.velocity.x, this._dy = t.velocity.y, t.velocity.x = this.velocity.x * t.bounce.x, t.velocity.y = this.velocity.y * t.bounce.x, this.velocity.x = this._dx * this.bounce.x, this.velocity.y = this._dy * this.bounce.y;
            else {
                var e = Math.sqrt(t.velocity.x * t.velocity.x * t.mass / this.mass) * (t.velocity.x > 0 ? 1 : -1), i = Math.sqrt(this.velocity.x * this.velocity.x * this.mass / t.mass) * (this.velocity.x > 0 ? 1 : -1), s = .5 * (e + i);
            ...
            if (this.inContact(t))
                return !1;
            if (this._distances[0] = t.right - this.x, this._distances[1] = this.right - t.x, this._distances[2] = t.bottom - this.y, this._distances[3] = this.bottom - t.y, !e.overlapN.x || 0 !== this._distances[0] && 0 !== this._distances[1] ? !e.overlapN.y || 0 !== this._distances[2] && 0 !== this._distances[3] || (e.overlapN.x = !0, e.overlapN.y = !1) : (e.overlapN.x = !1, e.overlapN.y = !0), this.customSeparateCallback)
            ...
            if (this.type = i.Physics.Arcade.POLYGON, this.shape = null, Array.isArray(t) || (t = Array.prototype.slice.call(arguments)), "number" == typeof t[0]) {
                for (var e = [], s = 0, n = t.length; n > s; s += 2)
                    e.push(new SAT.Vector(t[s], t[s + 1]));
                t = e
            }
        ...
        }}, i.Physics.Arcade.Body.prototype.constructor = i.Physics.Arcade.Body, Object.defineProperty(i.Physics.Arcade.Body.prototype, "x", {get: function() {
        ...
        }}), Object.defineProperty(i.Physics.Arcade.Body.prototype, "y", {get: function() {
    ...
    }, i.Particles.prototype = {add: function(t) {
    ...
    }, Object.defineProperty(i.Particles.Arcade.Emitter.prototype, "alpha", {get: function() {
            return this._container.alpha
        },set: function(t) {
            this._container.alpha = t
        }}), Object.defineProperty(i.Particles.Arcade.Emitter.prototype, "visible", {get: function() {
            return this._container.visible
        },set: function(t) {
            this._container.visible = t
        }}), Object.defineProperty(i.Particles.Arcade.Emitter.prototype, "x", {get: function() {
            return this.emitX
        },set: function(t) {
            this.emitX = t
        }}), Object.defineProperty(i.Particles.Arcade.Emitter.prototype, "y", {get: function() {
            return this.emitY
        },set: function(t) {
            this.emitY = t
        }}), Object.defineProperty(i.Particles.Arcade.Emitter.prototype, "left", {get: function() {
            return Math.floor(this.x - this.width / 2)
        }}), Object.defineProperty(i.Particles.Arcade.Emitter.prototype, "right", {get: function() {
            return Math.floor(this.x + this.width / 2)
        }}), Object.defineProperty(i.Particles.Arcade.Emitter.prototype, "top", {get: function() {
            return Math.floor(this.y - this.height / 2)
        }}), Object.defineProperty(i.Particles.Arcade.Emitter.prototype, "bottom", {get: function() {
            return Math.floor(this.y + this.height / 2)
    ...
    }, i.Tile.prototype = {setCollisionCallback: function(t, e) {
        ...
        }}, i.Tile.prototype.constructor = i.Tile, Object.defineProperty(i.Tile.prototype, "canCollide", {get: function() {
            return this.collides || this.collisionCallback || this.layer.callbacks[this.index]
        }}), Object.defineProperty(i.Tile.prototype, "left", {get: function() {
            return this.x
        }}), Object.defineProperty(i.Tile.prototype, "right", {get: function() {
            return this.x + this.width
        }}), Object.defineProperty(i.Tile.prototype, "top", {get: function() {
            return this.y
        }}), Object.defineProperty(i.Tile.prototype, "bottom", {get: function() {
            return this.y + this.height
        ...
        null !== s && (this.width = s.width, this.height = s.height, this.tileWidth = s.tileWidth, this.tileHeight = s.tileHeight, this.orientation = s.orientation, this.version = s.version, this.properties = s.properties, this.widthInPixels = s.widthInPixels, this.heightInPixels = s.heightInPixels, this.layers = s.layers, this.tilesets = s.tilesets, this.tiles = s.tiles, this.objects = s.objects, this.images = s.images, this.currentLayer = 0, this.debugMap = [], this._results = [], this._tempA = 0, this._tempB = 0)
    }, i.Tilemap.CSV = 0, i.Tilemap.TILED_JSON = 1, i.Tilemap.prototype = {create: function(t, e, s) {
            for (var n = [], r = 0; s > r; r++) {
                n[r] = [];
                for (var o = 0; e > o; o++)
                    n[r][o] = 0
            ...
            for (var a, h = 0, l = this.objects[t].length; l > h; h++)
                if (this.objects[t][h].gid === e) {
                    ...
                    for (property in this.objects[t][h].properties)
                        o.set(a, property, this.objects[t][h].properties[property], !1, !1, 0)
                }
            ...
            if (s = this.getLayer(s), "number" == typeof t)
                this.layers[s].callbacks[t] = {callback: e,callbackContext: i};
            else
                for (var n = 0, r = t.length; r > n; n++)
                    this.layers[s].callbacks[t[n]] = {callback: e,callbackContext: i}
            ...
            if ("undefined" == typeof e && (e = !0), i = this.getLayer(i), "number" == typeof t)
            ...
            "undefined" == typeof t && (t = 0), "undefined" == typeof e && (e = 0), "undefined" == typeof i && (i = this.layers[n].width), "undefined" == typeof s && (s = this.layers[n].height), 0 > t && (t = 0), 0 > e && (e = 0), i > this.layers[n].width && (i = this.layers[n].width), s > this.layers[n].height && (s = this.layers[n].height), this._results.length = 0, this._results.push({x: t,y: e,width: i,height: s,layer: n});
            for (var r = e; e + s > r; r++)
                for (var o = t; t + i > o; o++)
            ...
            if ("undefined" == typeof t && (t = 0), "undefined" == typeof e && (e = 0), s = this.getLayer(s), i && !(i.length < 2)) {
                for (var n = i[1].x - t, r = i[1].y - e, o = 1; o < i.length; o++)
            ...
            if (r = this.getLayer(r), this.copy(t, e, s, n, r), !(this._results.length < 2)) {
                for (var o = [], a = 1; a < this._results.length; a++)
                    this._results[a].index && o.push(this._results[a].index);
                i.Utils.shuffle(o);
                for (var h = 1; h < this._results.length; h++)
            ...
            for (var t = "", e = [""], i = 0; i < this.layers[this.currentLayer].height; i++) {
                for (var s = 0; s < this.layers[this.currentLayer].width; s++)
                    t += "%c  ", e.push(this.layers[this.currentLayer].data[i][s] > 1 ? this.debugMap[this.layers[this.currentLayer].data[i][s]] ? "background: " + this.debugMap[this.layers[this.currentLayer].data[i][s]] : "background: #ffffff" : "background: rgb(0, 0, 0)");
                t += "\n"
            }
        ...
        for (var r = this._ty; r < this._ty + this._th; r++)
            for (var o = this._tx; o < this._tx + this._tw; o++)
                if (this.layer.data[r] && this.layer.data[r][o] && (n === !1 || n && this.layer.data[r][o].canCollide)) {
                    var a = this._unfixX(o * this._cw) / this._cw, h = this._unfixY(r * this._ch) / this._ch;
        ...
        for (var t = this._startY, e = this._startY + this._maxY; e > t; t++) {
    ...
    }, Object.defineProperty(i.TilemapLayer.prototype, "scrollX", {get: function() {
            return this._x
        },set: function(t) {
        ...
        }}), Object.defineProperty(i.TilemapLayer.prototype, "scrollY", {get: function() {
            return this._y
        },set: function(t) {
        ...
        }}), Object.defineProperty(i.TilemapLayer.prototype, "collisionWidth", {get: function() {
            return this._cw
        },set: function(t) {
            this._cw = t, this.dirty = !0
        }}), Object.defineProperty(i.TilemapLayer.prototype, "collisionHeight", {get: function() {
            return this._ch
        },set: function(t) {
            this._ch = t, this.dirty = !0
        }}), i.TilemapParser = {tileset: function(t, e, s, n, r, o, a, h, l) {
            var c = t.cache.getTilesetImage(e);
            if (null === c)
                return console.warn("Phaser.TilemapParser.tileSet: Invalid image key given"), null;
            var u = c.width, d = c.height;
            ...
            for (var e = [], i = t.split("\n"), s = i.length, n = 0, r = 0; r < i.length; r++) {
                e[r] = [];
                for (var o = i[r].split(","), a = 0; a < o.length; a++)
                    e[r][a] = parseInt(o[a], 10);
                0 === n && (n = o.length)
            }
            ...
            for (var s = [], n = 0; n < t.layers.length; n++)
                if ("tilelayer" === t.layers[n].type) {
                    var r = {name: t.layers[n].name,x: t.layers[n].x,y: t.layers[n].y,width: t.layers[n].width,height: t.layers[n].height,widthInPixels: t.layers[n].width * t.tilewidth,heightInPixels: t.layers[n].height * t.tileheight,alpha: t.layers[n].opacity,visible: t.layers[n].visible,properties: {},indexes: [],callbacks: []};
                ...
                if ("objectgroup" === t.layers[n].type) {
                    ...
                    for (var f = 0, c = t.layers[n].objects.length; c > f; f++)
                        if (t.layers[n].objects[f].gid) {
                            var g = {gid: t.layers[n].objects[f].gid,name: t.layers[n].objects[f].name,x: t.layers[n].objects[f].x,y: t.layers[n].objects[f].y,visible: t.layers[n].objects[f].visible,properties: t.layers[n].objects[f].properties};
                            p[t.layers[n].name].push(g)
                        }
                }
            e.objects = p;
            for (var m = [], n = 0; n < t.tilesets.length; n++) {
                var y = t.tilesets[n], _ = new i.Tileset(y.name, y.firstgid, y.tilewidth, y.tileheight, y.margin, y.spacing, y.properties);
    ...
    }, i.Tileset.prototype = {setSpacing: function(t, e) {
            ...
            if (t.visible || s)
                if (t.renderable && 0 !== t.alpha) {
                    if (t instanceof e.Sprite)
                        ...
                        if (t.open) {
                            this.context.save();
                            var r = t.mask.alpha, o = t.mask.worldTransform;
        ...
        for (var t, i, s, n, r, o, a, h, l, c, u, d, p, f, g, m, y = 0, _ = this.head; _; ) {
            if (_.vcount === e.visibleCount) {
                if (i = _.texture.frame.width, s = _.texture.frame.height, n = _.anchor.x, r = _.anchor.y, o = i * (1 - n), a = i * -n, h = s * (1 - r), l = s * -r, c = 8 * y, t = _.worldTransform, u = t[0], d = t[3], p = t[1], f = t[4], g = t[2], m = t[5], _.texture.trimmed && (g += _.texture.trim.x, m += _.texture.trim.y), this.verticies[c + 0] = u * a + p * l + g, this.verticies[c + 1] = f * l + d * a + m, this.verticies[c + 2] = u * o + p * l + g, this.verticies[c + 3] = f * l + d * o + m, this.verticies[c + 4] = u * o + p * h + g, this.verticies[c + 5] = f * h + d * o + m, this.verticies[c + 6] = u * a + p * h + g, this.verticies[c + 7] = f * h + d * a + m, _.updateFrame || _.texture.updateFrame) {
                    this.dirtyUVS = !0;
                    var x = _.texture, v = x.frame, b = x.baseTexture.width, w = x.baseTexture.height;
                ...
                c = 8 * y, this.verticies[c + 0] = 0, this.verticies[c + 1] = 0, this.verticies[c + 2] = 0, this.verticies[c + 3] = 0, this.verticies[c + 4] = 0, this.verticies[c + 5] = 0, this.verticies[c + 6] = 0, this.verticies[c + 7] = 0;
            y++, _ = _.__next
        }
    }, i
});
...
DEBUG = !1, SPEED = 160, GRAVITY = 1100, FLAP = 320, SPAWN_RATE = 1 / 1200, OPENING = 100, SCALE = 1, HEIGHT = 384, WIDTH = 288, GAME_HEIGHT = 336, GROUND_HEIGHT = 64, GROUND_Y = HEIGHT - GROUND_HEIGHT, parent = document.querySelector("#screen"), gameStarted = void 0, gameOver = void 0, deadTubeTops = [], deadTubeBottoms = [], deadInvs = [], bg = null, tubes = null, invs = null, bird = null, ground = null, score = null, scoreText = null, instText = null, gameOverText = null, flapSnd = null, scoreSnd = null, hurtSnd = null, fallSnd = null, swooshSnd = null, tubesTimer = null, githubHtml = '<iframe src="http://ghbtns.com/github-btn.html?user=dombili&repo=FlappyTayyip&type=watch&count=true&size=large"\nallowtransparency="true" frameborder="0" scrolling="0" width="150" height="30"></iframe>', floor = Math.floor, main = function() {
    ...
    h = function(t, e) {
        ...
        var t;
        gameOver = !0, bird.body.velocity.y > 0 && (bird.body.velocity.y = 100), bird.animations.stop(), bird.frame = 1, instText.setText("Tekrar oynamak için\nherhangi bir yere tıklayın"), instText.renderable = !0, t = window.localStorage.getItem("hiscore"), t = t ? t : score, t = score > parseInt(t, 10) ? score : t, window.localStorage.setItem("hiscore", t), gameOverText.setText("OYUN BiTTi\n\n\Yüksek Skor:" + t), gameOverText.renderable = !0, tubes.forEachAlive(function(t) {
            t.body.velocity.x = 0
        ...
        var t;
        gameStarted || c(), gameOver || (bird.body.gravity.y = 0, bird.body.velocity.y = -100, t = s.add.tween(bird.body.velocity).to({y: -FLAP}, 25, Phaser.Easing.Bounce.In, !0), t.onComplete.add(function() {
            return bird.body.gravity.y = GRAVITY
        }), flapSnd.play())
    }, n = function() {
        var t;
        t = {spritesheet: {bird: ["assets/bird.png", 36, 26]},image: {tubeTop: ["assets/tube1.png"],tubeBottom: ["assets/tube2.png"],ground: ["assets/ground.png"],bg: ["assets/bg.png"]},audio: {flap: ["assets/sfx_wing.mp3"],score: ["assets/sfx_point.mp3"],hurt: ["assets/sfx_hit.mp3"],fall: ["assets/sfx_die.mp3"],swoosh: ["assets/sfx_swooshing.mp3"]}}, Object.keys(t).forEach(function(e) {
        ...
        var e;
        gameStarted ? gameOver ? (e = s.add.tween(bird).to({angle: 90}, 100, Phaser.Easing.Bounce.Out, !0), bird.body.bottom >= GROUND_Y + 3 && (bird.y = GROUND_Y - 13, bird.body.velocity.y = 0, bird.body.allowGravity = !1, bird.body.gravity.y = 0)) : (bird.angle = 90 * (FLAP + bird.body.velocity.y) / FLAP - 180, bird.angle < -30 && (bird.angle = -30), bird.angle > 80 ? (bird.angle = 90, bird.animations.stop(), bird.frame = 1) : bird.animations.play(), s.physics.overlap(bird, tubes, function() {
    ...
    }, u = {preload: n,create: e,update: d,render: r}, s = new Phaser.Game(WIDTH, HEIGHT, Phaser.CANVAS, parent, u, !1, !1)
}, WebFontConfig = {google: {families: ["Press+Start+2P::latin"]},active: main}, function() {
    var t, e;
